...
exports.ArticlesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsArticlesGet: function (page, limit, lastRetrieved, current, searchString, hospitalId, options) {
            if (options === void 0) { options = {}; }
...
exports.ArticlesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (page, limit, lastRetrieved, current, searchString, hospitalId, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsArticlesGet(page, limit, lastRetrieved, current, searchString, hospitalId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ArticlesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (page, limit, lastRetrieved, current, searchString, hospitalId, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsArticlesGet(page, limit, lastRetrieved, current, searchString, hospitalId, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/articles/1
         * @summary Delete article.
...
var ArticlesApi = /** @class */ (function (_super) {
     ...
     */
    ArticlesApi.prototype.apiV1HospitalsArticlesGet = function (page, limit, lastRetrieved, current, searchString, hospitalId, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsArticlesGet(page, limit, lastRetrieved, current, searchString, hospitalId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/articles/1
     * @summary Delete article.
...
exports.DoctorsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options) {
            if (options === void 0) { options = {}; }
...
exports.DoctorsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options) {
            var localVarAxiosArgs = exports.DoctorsApiAxiosParamCreator(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options) {
            return exports.DoctorsApiFp(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create hospital doctor.
...
var DoctorsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorsApi
     */
    DoctorsApi.prototype.apiV1DoctorsGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options) {
        return exports.DoctorsApiFp(this.configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, hospitalId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create hospital doctor.
...
exports.HospitalSpecialtiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalSpecialtiesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalSpecialtiesApiAxiosParamCreator(configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalSpecialtiesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options) {
            return exports.HospitalSpecialtiesApiFp(configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var HospitalSpecialtiesApi = /** @class */ (function (_super) {
     ...
     * @memberof HospitalSpecialtiesApi
     */
    HospitalSpecialtiesApi.prototype.apiV1HospitalsSpecialtiesGet = function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options) {
        return exports.HospitalSpecialtiesApiFp(this.configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
...
exports.HospitalsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsGet(id, name, description, countryId, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, page, limit, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsGet(id, name, description, countryId, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1
         * @summary Delete hospital.
...
var HospitalsApi = /** @class */ (function (_super) {
     ...
     */
    HospitalsApi.prototype.apiV1HospitalsGet = function (id, name, description, countryId, created, page, limit, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsGet(id, name, description, countryId, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1
     * @summary Delete hospital.
...
exports.ServicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ServicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var ServicesApi = /** @class */ (function (_super) {
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsServicesGet = function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, procedure, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return ServicesApi;
}(base_1.BaseAPI));
