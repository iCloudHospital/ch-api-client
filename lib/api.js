...
(function (BookingType) {
    ...
    BookingType["TeleHealth"] = "TeleHealth";
...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdDealDelete: function (bookingId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
                throw new base_1.RequiredError('bookingId', 'Required parameter bookingId was null or undefined when calling apiV1BookingsBookingIdDealDelete.');
            }
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsBookingIdDealDelete: function (bookingId, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdDealDelete(bookingId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsBookingIdDealDelete: function (bookingId, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdDealDelete(bookingId, options)(axios, basePath);
        },
        /**
         *
         * @summary Update deal booking.
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdDealDelete = function (bookingId, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdDealDelete(bookingId, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Update deal booking.
