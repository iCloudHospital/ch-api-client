...
exports.PackagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PackagesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PackagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var PackagesApi = /** @class */ (function (_super) {
     ...
     * @memberof PackagesApi
     */
    PackagesApi.prototype.apiV1HospitalsPackagesGet = function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return PackagesApi;
}(base_1.BaseAPI));
