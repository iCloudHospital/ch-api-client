...
exports.CHAdminsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChadminsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            if (options === void 0) { options = {}; }
...
exports.CHAdminsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChadminsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            var localVarAxiosArgs = exports.CHAdminsApiAxiosParamCreator(configuration).apiV1ChadminsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHAdminsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChadminsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            return exports.CHAdminsApiFp(configuration).apiV1ChadminsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/chadmins      {          \"firstName\": \"Cloud\",          \"lastName\": \"Hospital\",          \"photo\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"photoThumbnail\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T09:09:19.082Z\",          \"locations\": [              {                  \"locationType\": \"LivesIn\",                  \"latitude\": 0,                  \"longitude\": 0,                  \"country\": \"string\",                  \"state\": \"string\",                  \"county\": \"string\",                  \"city\": \"string\",                  \"zipCode\": \"string\",                  \"address\": \"string\"              }          ]      }
         * @summary Create cloud hospital admin user.
...
var CHAdminsApi = /** @class */ (function (_super) {
     ...
     * @memberof CHAdminsApi
     */
    CHAdminsApi.prototype.apiV1ChadminsGet = function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
        return exports.CHAdminsApiFp(this.configuration).apiV1ChadminsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/chadmins      {          \"firstName\": \"Cloud\",          \"lastName\": \"Hospital\",          \"photo\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"photoThumbnail\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T09:09:19.082Z\",          \"locations\": [              {                  \"locationType\": \"LivesIn\",                  \"latitude\": 0,                  \"longitude\": 0,                  \"country\": \"string\",                  \"state\": \"string\",                  \"county\": \"string\",                  \"city\": \"string\",                  \"zipCode\": \"string\",                  \"address\": \"string\"              }          ]      }
     * @summary Create cloud hospital admin user.
...
exports.CHManagersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChmanagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            if (options === void 0) { options = {}; }
...
exports.CHManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChmanagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            var localVarAxiosArgs = exports.CHManagersApiAxiosParamCreator(configuration).apiV1ChmanagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChmanagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            return exports.CHManagersApiFp(configuration).apiV1ChmanagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/chmanagers      {          \"userName\": \"chmanager\",          \"email\": \"chmanger@icloudhospital.com\",          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [             {             \"locationType\": \"LivesIn\",             \"latitude\": 0,             \"longitude\": 0,             \"country\": \"string\",             \"state\": \"string\",             \"county\": \"string\",             \"city\": \"string\",             \"zipCode\": \"string\",             \"address\": \"string\"             }          ]       }
         * @summary Create cloud hospital manager.
...
var CHManagersApi = /** @class */ (function (_super) {
     ...
     * @memberof CHManagersApi
     */
    CHManagersApi.prototype.apiV1ChmanagersGet = function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
        return exports.CHManagersApiFp(this.configuration).apiV1ChmanagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/chmanagers      {          \"userName\": \"chmanager\",          \"email\": \"chmanger@icloudhospital.com\",          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [             {             \"locationType\": \"LivesIn\",             \"latitude\": 0,             \"longitude\": 0,             \"country\": \"string\",             \"state\": \"string\",             \"county\": \"string\",             \"city\": \"string\",             \"zipCode\": \"string\",             \"address\": \"string\"             }          ]       }
     * @summary Create cloud hospital manager.
...
exports.ConsultationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsPost: function (body, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/consultations";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
...
exports.ConsultationsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ConsultationsPost: function (body, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsPost(body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ConsultationsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ConsultationsPost: function (body, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsPost(body, options)(axios, basePath);
        },
    };
};
/**
...
var ConsultationsApi = /** @class */ (function (_super) {
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsPost = function (body, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsPost(body, options)(this.axios, this.basePath);
    };
...
exports.ManagersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ManagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options) {
            if (options === void 0) { options = {}; }
...
exports.ManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ManagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options) {
            var localVarAxiosArgs = exports.ManagersApiAxiosParamCreator(configuration).apiV1ManagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ManagersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options) {
            return exports.ManagersApiFp(configuration).apiV1ManagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/managers/1
         * @summary Delete hospital manager.
...
var ManagersApi = /** @class */ (function (_super) {
     ...
     */
    ManagersApi.prototype.apiV1ManagersGet = function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options) {
        return exports.ManagersApiFp(this.configuration).apiV1ManagersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, hospitalId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/managers/1
     * @summary Delete hospital manager.
...
exports.PartnersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PartnersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            if (options === void 0) { options = {}; }
...
exports.PartnersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PartnersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            var localVarAxiosArgs = exports.PartnersApiAxiosParamCreator(configuration).apiV1PartnersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PartnersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PartnersGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            return exports.PartnersApiFp(configuration).apiV1PartnersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/partners/1
         * @summary Delete patner.
...
var PartnersApi = /** @class */ (function (_super) {
     ...
     */
    PartnersApi.prototype.apiV1PartnersGet = function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
        return exports.PartnersApiFp(this.configuration).apiV1PartnersGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/partners/1
     * @summary Delete patner.
...
exports.PatientsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PatientsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            if (options === void 0) { options = {}; }
...
exports.PatientsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PatientsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            var localVarAxiosArgs = exports.PatientsApiAxiosParamCreator(configuration).apiV1PatientsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PatientsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PatientsGet: function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
            return exports.PatientsApiFp(configuration).apiV1PatientsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/patients/1
         * @summary Delete patient.
...
var PatientsApi = /** @class */ (function (_super) {
     ...
     */
    PatientsApi.prototype.apiV1PatientsGet = function (page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options) {
        return exports.PatientsApiFp(this.configuration).apiV1PatientsGet(page, limit, lastRetrieved, current, id, fullname, email, gender, dateOfBirth, created, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/patients/1
     * @summary Delete patient.
