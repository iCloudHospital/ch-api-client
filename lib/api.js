...
exports.ArticlesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdArticlesSlugsSlugGet: function (hospitalId, slug, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
                throw new base_1.RequiredError('hospitalId', 'Required parameter hospitalId was null or undefined when calling apiV1HospitalsHospitalIdArticlesSlugsSlugGet.');
            }
            // verify required parameter 'slug' is not null or undefined
            if (slug === null || slug === undefined) {
                throw new base_1.RequiredError('slug', 'Required parameter slug was null or undefined when calling apiV1HospitalsHospitalIdArticlesSlugsSlugGet.');
            }
            var localVarPath = "/api/v1/hospitals/{hospitalId}/articles/slugs/{slug}"
                .replace("{" + "hospitalId" + "}", encodeURIComponent(String(hospitalId)))
...
exports.ArticlesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdArticlesSlugsSlugGet: function (hospitalId, slug, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdArticlesSlugsSlugGet(hospitalId, slug, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ArticlesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdArticlesSlugsSlugGet: function (hospitalId, slug, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsHospitalIdArticlesSlugsSlugGet(hospitalId, slug, options)(axios, basePath);
        },
    };
};
/**
...
var ArticlesApi = /** @class */ (function (_super) {
     ...
     * @memberof ArticlesApi
     */
    ArticlesApi.prototype.apiV1HospitalsHospitalIdArticlesSlugsSlugGet = function (hospitalId, slug, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsHospitalIdArticlesSlugsSlugGet(hospitalId, slug, options)(this.axios, this.basePath);
    };
    return ArticlesApi;
}(base_1.BaseAPI));
