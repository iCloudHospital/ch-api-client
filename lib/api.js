...
exports.ServicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ServicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var ServicesApi = /** @class */ (function (_super) {
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsServicesGet = function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, marketingType, procedure, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return ServicesApi;
}(base_1.BaseAPI));
