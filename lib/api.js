...
exports.ArticlesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdArticlesArticleIdPut: function (hospitalId, articleId, updateArticleCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateArticleCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateArticleCommand !== undefined ? updateArticleCommand : {}) : (updateArticleCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdArticlesPost: function (hospitalId, createArticleCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createArticleCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createArticleCommand !== undefined ? createArticleCommand : {}) : (createArticleCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ArticlesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdArticlesArticleIdPut: function (hospitalId, articleId, updateArticleCommand, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdArticlesArticleIdPut(hospitalId, articleId, updateArticleCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdArticlesPost: function (hospitalId, createArticleCommand, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdArticlesPost(hospitalId, createArticleCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ArticlesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdArticlesArticleIdPut: function (hospitalId, articleId, updateArticleCommand, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsHospitalIdArticlesArticleIdPut(hospitalId, articleId, updateArticleCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/hospitals/1/articles      {          \"title\": \"Samsung Hospital Article\",          \"description\": \"This is an article.\",          \"body\": \"article body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"tags\": [            {              \"value\": \"string\",              \"order\": 0              }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
         * @summary Create an article.
         ...
         */
        apiV1HospitalsHospitalIdArticlesPost: function (hospitalId, createArticleCommand, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsHospitalIdArticlesPost(hospitalId, createArticleCommand, options)(axios, basePath);
        },
    };
};
/**
...
var ArticlesApi = /** @class */ (function (_super) {
     ...
     * @memberof ArticlesApi
     */
    ArticlesApi.prototype.apiV1HospitalsHospitalIdArticlesArticleIdPut = function (hospitalId, articleId, updateArticleCommand, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsHospitalIdArticlesArticleIdPut(hospitalId, articleId, updateArticleCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/hospitals/1/articles      {          \"title\": \"Samsung Hospital Article\",          \"description\": \"This is an article.\",          \"body\": \"article body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"tags\": [            {              \"value\": \"string\",              \"order\": 0              }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
     * @summary Create an article.
     ...
     * @memberof ArticlesApi
     */
    ArticlesApi.prototype.apiV1HospitalsHospitalIdArticlesPost = function (hospitalId, createArticleCommand, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsHospitalIdArticlesPost(hospitalId, createArticleCommand, options)(this.axios, this.basePath);
    };
    return ArticlesApi;
}(base_1.BaseAPI));
...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdApprovePost: function (bookingId, approveBookingCommand, options) {
            if (options === void 0) { options = {}; }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof approveBookingCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(approveBookingCommand !== undefined ? approveBookingCommand : {}) : (approveBookingCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdPut: function (bookingId, updateBookingCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateBookingCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateBookingCommand !== undefined ? updateBookingCommand : {}) : (updateBookingCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdRejectPost: function (bookingId, rejectBookingCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof rejectBookingCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(rejectBookingCommand !== undefined ? rejectBookingCommand : {}) : (rejectBookingCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsRequestIdPost: function (requestId, createBookingCommand, options) {
            if (options === void 0) { options = {}; }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createBookingCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createBookingCommand !== undefined ? createBookingCommand : {}) : (createBookingCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsBookingIdApprovePost: function (bookingId, approveBookingCommand, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdApprovePost(bookingId, approveBookingCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdPut: function (bookingId, updateBookingCommand, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdPut(bookingId, updateBookingCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdRejectPost: function (bookingId, rejectBookingCommand, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdRejectPost(bookingId, rejectBookingCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsRequestIdPost: function (requestId, createBookingCommand, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsRequestIdPost(requestId, createBookingCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsBookingIdApprovePost: function (bookingId, approveBookingCommand, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdApprovePost(bookingId, approveBookingCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Cancel booking.
         ...
         */
        apiV1BookingsBookingIdPut: function (bookingId, updateBookingCommand, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdPut(bookingId, updateBookingCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Reject booking.
         ...
         */
        apiV1BookingsBookingIdRejectPost: function (bookingId, rejectBookingCommand, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdRejectPost(bookingId, rejectBookingCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get all bookings.
         ...
         */
        apiV1BookingsRequestIdPost: function (requestId, createBookingCommand, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsRequestIdPost(requestId, createBookingCommand, options)(axios, basePath);
        },
    };
};
/**
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     */
    BookingsApi.prototype.apiV1BookingsBookingIdApprovePost = function (bookingId, approveBookingCommand, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdApprovePost(bookingId, approveBookingCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Cancel booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdPut = function (bookingId, updateBookingCommand, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdPut(bookingId, updateBookingCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Reject booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdRejectPost = function (bookingId, rejectBookingCommand, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdRejectPost(bookingId, rejectBookingCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get all bookings.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsRequestIdPost = function (requestId, createBookingCommand, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsRequestIdPost(requestId, createBookingCommand, options)(this.axios, this.basePath);
    };
    return BookingsApi;
}(base_1.BaseAPI));
...
exports.CHAdminsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChadminsChAdminIdPut: function (chAdminId, updateCHAdminCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'chAdminId' is not null or undefined
            if (chAdminId === null || chAdminId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateCHAdminCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateCHAdminCommand !== undefined ? updateCHAdminCommand : {}) : (updateCHAdminCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ChadminsPost: function (createCHAdminCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/chadmins";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createCHAdminCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createCHAdminCommand !== undefined ? createCHAdminCommand : {}) : (createCHAdminCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.CHAdminsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChadminsChAdminIdPut: function (chAdminId, updateCHAdminCommand, options) {
            var localVarAxiosArgs = exports.CHAdminsApiAxiosParamCreator(configuration).apiV1ChadminsChAdminIdPut(chAdminId, updateCHAdminCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ChadminsPost: function (createCHAdminCommand, options) {
            var localVarAxiosArgs = exports.CHAdminsApiAxiosParamCreator(configuration).apiV1ChadminsPost(createCHAdminCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHAdminsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChadminsChAdminIdPut: function (chAdminId, updateCHAdminCommand, options) {
            return exports.CHAdminsApiFp(configuration).apiV1ChadminsChAdminIdPut(chAdminId, updateCHAdminCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/chadmin      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"admin\"      }
         * @summary Get cloud hospital admin users.
         ...
         */
        apiV1ChadminsPost: function (createCHAdminCommand, options) {
            return exports.CHAdminsApiFp(configuration).apiV1ChadminsPost(createCHAdminCommand, options)(axios, basePath);
        },
    };
};
/**
...
var CHAdminsApi = /** @class */ (function (_super) {
     ...
     * @memberof CHAdminsApi
     */
    CHAdminsApi.prototype.apiV1ChadminsChAdminIdPut = function (chAdminId, updateCHAdminCommand, options) {
        return exports.CHAdminsApiFp(this.configuration).apiV1ChadminsChAdminIdPut(chAdminId, updateCHAdminCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/chadmin      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"admin\"      }
     * @summary Get cloud hospital admin users.
     ...
     * @memberof CHAdminsApi
     */
    CHAdminsApi.prototype.apiV1ChadminsPost = function (createCHAdminCommand, options) {
        return exports.CHAdminsApiFp(this.configuration).apiV1ChadminsPost(createCHAdminCommand, options)(this.axios, this.basePath);
    };
    return CHAdminsApi;
}(base_1.BaseAPI));
...
exports.CHManagersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChmanagersChManagerIdPut: function (chManagerId, updateCHManagerCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'chManagerId' is not null or undefined
            if (chManagerId === null || chManagerId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateCHManagerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateCHManagerCommand !== undefined ? updateCHManagerCommand : {}) : (updateCHManagerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ChmanagersPost: function (createCHManagerCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/chmanagers";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createCHManagerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createCHManagerCommand !== undefined ? createCHManagerCommand : {}) : (createCHManagerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.CHManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChmanagersChManagerIdPut: function (chManagerId, updateCHManagerCommand, options) {
            var localVarAxiosArgs = exports.CHManagersApiAxiosParamCreator(configuration).apiV1ChmanagersChManagerIdPut(chManagerId, updateCHManagerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ChmanagersPost: function (createCHManagerCommand, options) {
            var localVarAxiosArgs = exports.CHManagersApiAxiosParamCreator(configuration).apiV1ChmanagersPost(createCHManagerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChmanagersChManagerIdPut: function (chManagerId, updateCHManagerCommand, options) {
            return exports.CHManagersApiFp(configuration).apiV1ChmanagersChManagerIdPut(chManagerId, updateCHManagerCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/chmanagers      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"chmanager\"      }
         * @summary Get cloud hospital managers.
         ...
         */
        apiV1ChmanagersPost: function (createCHManagerCommand, options) {
            return exports.CHManagersApiFp(configuration).apiV1ChmanagersPost(createCHManagerCommand, options)(axios, basePath);
        },
    };
};
/**
...
var CHManagersApi = /** @class */ (function (_super) {
    ...
    CHManagersApi.prototype.apiV1ChmanagersChManagerIdPut = function (chManagerId, updateCHManagerCommand, options) {
        return exports.CHManagersApiFp(this.configuration).apiV1ChmanagersChManagerIdPut(chManagerId, updateCHManagerCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/chmanagers      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"chmanager\"      }
     * @summary Get cloud hospital managers.
    ...
    CHManagersApi.prototype.apiV1ChmanagersPost = function (createCHManagerCommand, options) {
        return exports.CHManagersApiFp(this.configuration).apiV1ChmanagersPost(createCHManagerCommand, options)(this.axios, this.basePath);
    };
...
exports.ConsultationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsConsultationIdApprovePost: function (consultationId, approveConsultationCommand, options) {
            if (options === void 0) { options = {}; }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof approveConsultationCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(approveConsultationCommand !== undefined ? approveConsultationCommand : {}) : (approveConsultationCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsConsultationIdPut: function (consultationId, updateConsultationCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'consultationId' is not null or undefined
            if (consultationId === null || consultationId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateConsultationCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateConsultationCommand !== undefined ? updateConsultationCommand : {}) : (updateConsultationCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsConsultationIdRejectPost: function (consultationId, rejectConsultationCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'consultationId' is not null or undefined
            if (consultationId === null || consultationId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof rejectConsultationCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(rejectConsultationCommand !== undefined ? rejectConsultationCommand : {}) : (rejectConsultationCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsRequestIdPost: function (requestId, createConsultationCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'requestId' is not null or undefined
            if (requestId === null || requestId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createConsultationCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createConsultationCommand !== undefined ? createConsultationCommand : {}) : (createConsultationCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ConsultationsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdApprovePost: function (consultationId, approveConsultationCommand, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsConsultationIdApprovePost(consultationId, approveConsultationCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ConsultationsConsultationIdPut: function (consultationId, updateConsultationCommand, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsConsultationIdPut(consultationId, updateConsultationCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ConsultationsConsultationIdRejectPost: function (consultationId, rejectConsultationCommand, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsConsultationIdRejectPost(consultationId, rejectConsultationCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ConsultationsRequestIdPost: function (requestId, createConsultationCommand, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsRequestIdPost(requestId, createConsultationCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ConsultationsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdApprovePost: function (consultationId, approveConsultationCommand, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsConsultationIdApprovePost(consultationId, approveConsultationCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Cancel consultation.
         ...
         */
        apiV1ConsultationsConsultationIdPut: function (consultationId, updateConsultationCommand, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsConsultationIdPut(consultationId, updateConsultationCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Reject consultation.
         ...
         */
        apiV1ConsultationsConsultationIdRejectPost: function (consultationId, rejectConsultationCommand, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsConsultationIdRejectPost(consultationId, rejectConsultationCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get all consultations.
         ...
         */
        apiV1ConsultationsRequestIdPost: function (requestId, createConsultationCommand, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsRequestIdPost(requestId, createConsultationCommand, options)(axios, basePath);
        },
    };
};
/**
...
var ConsultationsApi = /** @class */ (function (_super) {
     ...
     */
    ConsultationsApi.prototype.apiV1ConsultationsConsultationIdApprovePost = function (consultationId, approveConsultationCommand, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsConsultationIdApprovePost(consultationId, approveConsultationCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Cancel consultation.
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsConsultationIdPut = function (consultationId, updateConsultationCommand, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsConsultationIdPut(consultationId, updateConsultationCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Reject consultation.
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsConsultationIdRejectPost = function (consultationId, rejectConsultationCommand, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsConsultationIdRejectPost(consultationId, rejectConsultationCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get all consultations.
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsRequestIdPost = function (requestId, createConsultationCommand, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsRequestIdPost(requestId, createConsultationCommand, options)(this.axios, this.basePath);
    };
...
exports.CountriesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1CountriesCountryIdPut: function (countryId, updateCountryCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateCountryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateCountryCommand !== undefined ? updateCountryCommand : {}) : (updateCountryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1CountriesPost: function (createCountryCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/countries";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createCountryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createCountryCommand !== undefined ? createCountryCommand : {}) : (createCountryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.CountriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1CountriesCountryIdPut: function (countryId, updateCountryCommand, options) {
            var localVarAxiosArgs = exports.CountriesApiAxiosParamCreator(configuration).apiV1CountriesCountryIdPut(countryId, updateCountryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1CountriesPost: function (createCountryCommand, options) {
            var localVarAxiosArgs = exports.CountriesApiAxiosParamCreator(configuration).apiV1CountriesPost(createCountryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CountriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1CountriesCountryIdPut: function (countryId, updateCountryCommand, options) {
            return exports.CountriesApiFp(configuration).apiV1CountriesCountryIdPut(countryId, updateCountryCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/countries      {          \"countryPageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          }      }
         * @summary Get all countries.
         ...
         */
        apiV1CountriesPost: function (createCountryCommand, options) {
            return exports.CountriesApiFp(configuration).apiV1CountriesPost(createCountryCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get country by slug.
...
var CountriesApi = /** @class */ (function (_super) {
    ...
    CountriesApi.prototype.apiV1CountriesCountryIdPut = function (countryId, updateCountryCommand, options) {
        return exports.CountriesApiFp(this.configuration).apiV1CountriesCountryIdPut(countryId, updateCountryCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/countries      {          \"countryPageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          }      }
     * @summary Get all countries.
    ...
    CountriesApi.prototype.apiV1CountriesPost = function (createCountryCommand, options) {
        return exports.CountriesApiFp(this.configuration).apiV1CountriesPost(createCountryCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get country by slug.
...
exports.DealPackagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DealsDealIdPackagesPackageIdPut: function (dealId, packageId, updateDealPackageCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'dealId' is not null or undefined
            if (dealId === null || dealId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDealPackageCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDealPackageCommand !== undefined ? updateDealPackageCommand : {}) : (updateDealPackageCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1DealsDealIdPackagesPost: function (dealId, createDealPackageCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'dealId' is not null or undefined
            if (dealId === null || dealId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDealPackageCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDealPackageCommand !== undefined ? createDealPackageCommand : {}) : (createDealPackageCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DealPackagesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DealsDealIdPackagesPackageIdPut: function (dealId, packageId, updateDealPackageCommand, options) {
            var localVarAxiosArgs = exports.DealPackagesApiAxiosParamCreator(configuration).apiV1DealsDealIdPackagesPackageIdPut(dealId, packageId, updateDealPackageCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DealsDealIdPackagesPost: function (dealId, createDealPackageCommand, options) {
            var localVarAxiosArgs = exports.DealPackagesApiAxiosParamCreator(configuration).apiV1DealsDealIdPackagesPost(dealId, createDealPackageCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DealPackagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DealsDealIdPackagesPackageIdPut: function (dealId, packageId, updateDealPackageCommand, options) {
            return exports.DealPackagesApiFp(configuration).apiV1DealsDealIdPackagesPackageIdPut(dealId, packageId, updateDealPackageCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Create deal package.
         ...
         */
        apiV1DealsDealIdPackagesPost: function (dealId, createDealPackageCommand, options) {
            return exports.DealPackagesApiFp(configuration).apiV1DealsDealIdPackagesPost(dealId, createDealPackageCommand, options)(axios, basePath);
        },
    };
};
/**
...
var DealPackagesApi = /** @class */ (function (_super) {
     ...
     * @memberof DealPackagesApi
     */
    DealPackagesApi.prototype.apiV1DealsDealIdPackagesPackageIdPut = function (dealId, packageId, updateDealPackageCommand, options) {
        return exports.DealPackagesApiFp(this.configuration).apiV1DealsDealIdPackagesPackageIdPut(dealId, packageId, updateDealPackageCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create deal package.
     ...
     * @memberof DealPackagesApi
     */
    DealPackagesApi.prototype.apiV1DealsDealIdPackagesPost = function (dealId, createDealPackageCommand, options) {
        return exports.DealPackagesApiFp(this.configuration).apiV1DealsDealIdPackagesPost(dealId, createDealPackageCommand, options)(this.axios, this.basePath);
    };
...
exports.DealsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1DealsDealIdPut: function (dealId, updateDealCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDealCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDealCommand !== undefined ? updateDealCommand : {}) : (updateDealCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1DealsPost: function (createDealCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDealCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDealCommand !== undefined ? createDealCommand : {}) : (createDealCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DealsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DealsDealIdPut: function (dealId, updateDealCommand, options) {
            var localVarAxiosArgs = exports.DealsApiAxiosParamCreator(configuration).apiV1DealsDealIdPut(dealId, updateDealCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DealsGet: function (id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DealsApiAxiosParamCreator(configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DealsPost: function (createDealCommand, options) {
            var localVarAxiosArgs = exports.DealsApiAxiosParamCreator(configuration).apiV1DealsPost(createDealCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DealsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DealsDealIdPut: function (dealId, updateDealCommand, options) {
            return exports.DealsApiFp(configuration).apiV1DealsDealIdPut(dealId, updateDealCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get all deals.
         ...
         */
        apiV1DealsGet: function (id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options) {
            return exports.DealsApiFp(configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @summary Create deal.
         ...
         */
        apiV1DealsPost: function (createDealCommand, options) {
            return exports.DealsApiFp(configuration).apiV1DealsPost(createDealCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get deal by slug.
...
var DealsApi = /** @class */ (function (_super) {
     ...
     * @memberof DealsApi
     */
    DealsApi.prototype.apiV1DealsDealIdPut = function (dealId, updateDealCommand, options) {
        return exports.DealsApiFp(this.configuration).apiV1DealsDealIdPut(dealId, updateDealCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get all deals.
    ...
    DealsApi.prototype.apiV1DealsGet = function (id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options) {
        return exports.DealsApiFp(this.configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, specialtyId, specialtyTypeId, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create deal.
     ...
     * @memberof DealsApi
     */
    DealsApi.prototype.apiV1DealsPost = function (createDealCommand, options) {
        return exports.DealsApiFp(this.configuration).apiV1DealsPost(createDealCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get deal by slug.
...
exports.DepartmentApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost: function (hospitalId, departmentId, createDepartmentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDepartmentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDepartmentCommand !== undefined ? createDepartmentCommand : {}) : (createDepartmentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut: function (hospitalId, departmentId, updateDepartmentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDepartmentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDepartmentCommand !== undefined ? updateDepartmentCommand : {}) : (updateDepartmentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DepartmentApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost: function (hospitalId, departmentId, createDepartmentCommand, options) {
            var localVarAxiosArgs = exports.DepartmentApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost(hospitalId, departmentId, createDepartmentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut: function (hospitalId, departmentId, updateDepartmentCommand, options) {
            var localVarAxiosArgs = exports.DepartmentApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut(hospitalId, departmentId, updateDepartmentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DepartmentApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost: function (hospitalId, departmentId, createDepartmentCommand, options) {
            return exports.DepartmentApiFp(configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost(hospitalId, departmentId, createDepartmentCommand, options)(axios, basePath);
        },
        /**
         * Sample request:
         * @summary Update department.
         ...
         */
        apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut: function (hospitalId, departmentId, updateDepartmentCommand, options) {
            return exports.DepartmentApiFp(configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut(hospitalId, departmentId, updateDepartmentCommand, options)(axios, basePath);
        },
    };
};
/**
...
var DepartmentApi = /** @class */ (function (_super) {
     ...
     * @memberof DepartmentApi
     */
    DepartmentApi.prototype.apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost = function (hospitalId, departmentId, createDepartmentCommand, options) {
        return exports.DepartmentApiFp(this.configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPost(hospitalId, departmentId, createDepartmentCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:
     * @summary Update department.
     ...
     * @memberof DepartmentApi
     */
    DepartmentApi.prototype.apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut = function (hospitalId, departmentId, updateDepartmentCommand, options) {
        return exports.DepartmentApiFp(this.configuration).apiV1HospitalsHospitalIdDepartmentsDepartmentIdPut(hospitalId, departmentId, updateDepartmentCommand, options)(this.axios, this.basePath);
    };
...
exports.DevicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DevicesDeviceIdLoginsPost: function (deviceId, createDeviceLoginCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDeviceLoginCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDeviceLoginCommand !== undefined ? createDeviceLoginCommand : {}) : (createDeviceLoginCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1DevicesDeviceIdPut: function (deviceId, updateDeviceCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDeviceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDeviceCommand !== undefined ? updateDeviceCommand : {}) : (updateDeviceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1DevicesPost: function (createDeviceCommand, options) {
            if (options === void 0) { options = {}; }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDeviceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDeviceCommand !== undefined ? createDeviceCommand : {}) : (createDeviceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DevicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DevicesDeviceIdLoginsPost: function (deviceId, createDeviceLoginCommand, options) {
            var localVarAxiosArgs = exports.DevicesApiAxiosParamCreator(configuration).apiV1DevicesDeviceIdLoginsPost(deviceId, createDeviceLoginCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DevicesDeviceIdPut: function (deviceId, updateDeviceCommand, options) {
            var localVarAxiosArgs = exports.DevicesApiAxiosParamCreator(configuration).apiV1DevicesDeviceIdPut(deviceId, updateDeviceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DevicesPost: function (createDeviceCommand, options) {
            var localVarAxiosArgs = exports.DevicesApiAxiosParamCreator(configuration).apiV1DevicesPost(createDeviceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DevicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DevicesDeviceIdLoginsPost: function (deviceId, createDeviceLoginCommand, options) {
            return exports.DevicesApiFp(configuration).apiV1DevicesDeviceIdLoginsPost(deviceId, createDeviceLoginCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Update device.
         ...
         */
        apiV1DevicesDeviceIdPut: function (deviceId, updateDeviceCommand, options) {
            return exports.DevicesApiFp(configuration).apiV1DevicesDeviceIdPut(deviceId, updateDeviceCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Create device.
         ...
         */
        apiV1DevicesPost: function (createDeviceCommand, options) {
            return exports.DevicesApiFp(configuration).apiV1DevicesPost(createDeviceCommand, options)(axios, basePath);
        },
    };
};
/**
...
var DevicesApi = /** @class */ (function (_super) {
     ...
     * @memberof DevicesApi
     */
    DevicesApi.prototype.apiV1DevicesDeviceIdLoginsPost = function (deviceId, createDeviceLoginCommand, options) {
        return exports.DevicesApiFp(this.configuration).apiV1DevicesDeviceIdLoginsPost(deviceId, createDeviceLoginCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Update device.
     ...
     * @memberof DevicesApi
     */
    DevicesApi.prototype.apiV1DevicesDeviceIdPut = function (deviceId, updateDeviceCommand, options) {
        return exports.DevicesApiFp(this.configuration).apiV1DevicesDeviceIdPut(deviceId, updateDeviceCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create device.
     ...
     * @memberof DevicesApi
     */
    DevicesApi.prototype.apiV1DevicesPost = function (createDeviceCommand, options) {
        return exports.DevicesApiFp(this.configuration).apiV1DevicesPost(createDeviceCommand, options)(this.axios, this.basePath);
    };
    return DevicesApi;
}(base_1.BaseAPI));
...
exports.DoctorCertificatesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1DoctorsDoctorIdCertificatesCertificateIdPut: function (doctorId, certificateId, updateDoctorCertificateCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDoctorCertificateCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDoctorCertificateCommand !== undefined ? updateDoctorCertificateCommand : {}) : (updateDoctorCertificateCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsDoctorIdCertificatesPost: function (doctorId, createDoctorCertificateCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'doctorId' is not null or undefined
            if (doctorId === null || doctorId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDoctorCertificateCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDoctorCertificateCommand !== undefined ? createDoctorCertificateCommand : {}) : (createDoctorCertificateCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DoctorCertificatesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdCertificatesCertificateIdPut: function (doctorId, certificateId, updateDoctorCertificateCommand, options) {
            var localVarAxiosArgs = exports.DoctorCertificatesApiAxiosParamCreator(configuration).apiV1DoctorsDoctorIdCertificatesCertificateIdPut(doctorId, certificateId, updateDoctorCertificateCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DoctorsDoctorIdCertificatesPost: function (doctorId, createDoctorCertificateCommand, options) {
            var localVarAxiosArgs = exports.DoctorCertificatesApiAxiosParamCreator(configuration).apiV1DoctorsDoctorIdCertificatesPost(doctorId, createDoctorCertificateCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorCertificatesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdCertificatesCertificateIdPut: function (doctorId, certificateId, updateDoctorCertificateCommand, options) {
            return exports.DoctorCertificatesApiFp(configuration).apiV1DoctorsDoctorIdCertificatesCertificateIdPut(doctorId, certificateId, updateDoctorCertificateCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/doctors/1/certificates/1
         * @summary Create certificate.
         ...
         */
        apiV1DoctorsDoctorIdCertificatesPost: function (doctorId, createDoctorCertificateCommand, options) {
            return exports.DoctorCertificatesApiFp(configuration).apiV1DoctorsDoctorIdCertificatesPost(doctorId, createDoctorCertificateCommand, options)(axios, basePath);
        },
    };
};
/**
...
var DoctorCertificatesApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorCertificatesApi
     */
    DoctorCertificatesApi.prototype.apiV1DoctorsDoctorIdCertificatesCertificateIdPut = function (doctorId, certificateId, updateDoctorCertificateCommand, options) {
        return exports.DoctorCertificatesApiFp(this.configuration).apiV1DoctorsDoctorIdCertificatesCertificateIdPut(doctorId, certificateId, updateDoctorCertificateCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/doctors/1/certificates/1
     * @summary Create certificate.
     ...
     * @memberof DoctorCertificatesApi
     */
    DoctorCertificatesApi.prototype.apiV1DoctorsDoctorIdCertificatesPost = function (doctorId, createDoctorCertificateCommand, options) {
        return exports.DoctorCertificatesApiFp(this.configuration).apiV1DoctorsDoctorIdCertificatesPost(doctorId, createDoctorCertificateCommand, options)(this.axios, this.basePath);
    };
...
exports.DoctorReviewsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsDoctorIdReviewsPatientIdPut: function (doctorId, patientId, updateDoctorReviewCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'doctorId' is not null or undefined
            if (doctorId === null || doctorId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDoctorReviewCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDoctorReviewCommand !== undefined ? updateDoctorReviewCommand : {}) : (updateDoctorReviewCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsDoctorIdReviewsPost: function (doctorId, patientId, createDoctorReviewCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'doctorId' is not null or undefined
            if (doctorId === null || doctorId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDoctorReviewCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDoctorReviewCommand !== undefined ? createDoctorReviewCommand : {}) : (createDoctorReviewCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DoctorReviewsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdReviewsPatientIdPut: function (doctorId, patientId, updateDoctorReviewCommand, options) {
            var localVarAxiosArgs = exports.DoctorReviewsApiAxiosParamCreator(configuration).apiV1DoctorsDoctorIdReviewsPatientIdPut(doctorId, patientId, updateDoctorReviewCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DoctorsDoctorIdReviewsPost: function (doctorId, patientId, createDoctorReviewCommand, options) {
            var localVarAxiosArgs = exports.DoctorReviewsApiAxiosParamCreator(configuration).apiV1DoctorsDoctorIdReviewsPost(doctorId, patientId, createDoctorReviewCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorReviewsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdReviewsPatientIdPut: function (doctorId, patientId, updateDoctorReviewCommand, options) {
            return exports.DoctorReviewsApiFp(configuration).apiV1DoctorsDoctorIdReviewsPatientIdPut(doctorId, patientId, updateDoctorReviewCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/doctors/1/reviews/1
         * @summary Create review.
         ...
         */
        apiV1DoctorsDoctorIdReviewsPost: function (doctorId, patientId, createDoctorReviewCommand, options) {
            return exports.DoctorReviewsApiFp(configuration).apiV1DoctorsDoctorIdReviewsPost(doctorId, patientId, createDoctorReviewCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/doctors/reviews
         * @summary Get all reviews.
...
var DoctorReviewsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorReviewsApi
     */
    DoctorReviewsApi.prototype.apiV1DoctorsDoctorIdReviewsPatientIdPut = function (doctorId, patientId, updateDoctorReviewCommand, options) {
        return exports.DoctorReviewsApiFp(this.configuration).apiV1DoctorsDoctorIdReviewsPatientIdPut(doctorId, patientId, updateDoctorReviewCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/doctors/1/reviews/1
     * @summary Create review.
     ...
     * @memberof DoctorReviewsApi
     */
    DoctorReviewsApi.prototype.apiV1DoctorsDoctorIdReviewsPost = function (doctorId, patientId, createDoctorReviewCommand, options) {
        return exports.DoctorReviewsApiFp(this.configuration).apiV1DoctorsDoctorIdReviewsPost(doctorId, patientId, createDoctorReviewCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/doctors/reviews
     * @summary Get all reviews.
...
exports.DoctorsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1DoctorsDoctorIdPut: function (doctorId, updateDoctorCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateDoctorCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateDoctorCommand !== undefined ? updateDoctorCommand : {}) : (updateDoctorCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1DoctorsPost: function (createDoctorCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createDoctorCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createDoctorCommand !== undefined ? createDoctorCommand : {}) : (createDoctorCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DoctorsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdPut: function (doctorId, updateDoctorCommand, options) {
            var localVarAxiosArgs = exports.DoctorsApiAxiosParamCreator(configuration).apiV1DoctorsDoctorIdPut(doctorId, updateDoctorCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1DoctorsPost: function (createDoctorCommand, options) {
            var localVarAxiosArgs = exports.DoctorsApiAxiosParamCreator(configuration).apiV1DoctorsPost(createDoctorCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsDoctorIdPut: function (doctorId, updateDoctorCommand, options) {
            return exports.DoctorsApiFp(configuration).apiV1DoctorsDoctorIdPut(doctorId, updateDoctorCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get all hospital doctors.
         ...
         */
        apiV1DoctorsPost: function (createDoctorCommand, options) {
            return exports.DoctorsApiFp(configuration).apiV1DoctorsPost(createDoctorCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get hospital doctor by slug.
...
var DoctorsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorsApi
     */
    DoctorsApi.prototype.apiV1DoctorsDoctorIdPut = function (doctorId, updateDoctorCommand, options) {
        return exports.DoctorsApiFp(this.configuration).apiV1DoctorsDoctorIdPut(doctorId, updateDoctorCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get all hospital doctors.
     ...
     * @memberof DoctorsApi
     */
    DoctorsApi.prototype.apiV1DoctorsPost = function (createDoctorCommand, options) {
        return exports.DoctorsApiFp(this.configuration).apiV1DoctorsPost(createDoctorCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get hospital doctor by slug.
...
exports.EquipmentsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut: function (hospitalId, equipmentId, updateEquipmentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateEquipmentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateEquipmentCommand !== undefined ? updateEquipmentCommand : {}) : (updateEquipmentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdEquipmentsPost: function (hospitalId, createEquipmentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createEquipmentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createEquipmentCommand !== undefined ? createEquipmentCommand : {}) : (createEquipmentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.EquipmentsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut: function (hospitalId, equipmentId, updateEquipmentCommand, options) {
            var localVarAxiosArgs = exports.EquipmentsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut(hospitalId, equipmentId, updateEquipmentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdEquipmentsPost: function (hospitalId, createEquipmentCommand, options) {
            var localVarAxiosArgs = exports.EquipmentsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdEquipmentsPost(hospitalId, createEquipmentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.EquipmentsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut: function (hospitalId, equipmentId, updateEquipmentCommand, options) {
            return exports.EquipmentsApiFp(configuration).apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut(hospitalId, equipmentId, updateEquipmentCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/hospitals/1/equipments      {          \"name\": \"Afroasia ltd\",          \"description\": \"Medical equipment\",          \"medias\": [            {              \"mediaType\": 0,              \"url\": \"imageurl\",              \"description\": \"string\",                      \"order\": 0            }          ]      }
         * @summary Create an equipment and add to a hospital.
         ...
         */
        apiV1HospitalsHospitalIdEquipmentsPost: function (hospitalId, createEquipmentCommand, options) {
            return exports.EquipmentsApiFp(configuration).apiV1HospitalsHospitalIdEquipmentsPost(hospitalId, createEquipmentCommand, options)(axios, basePath);
        },
    };
};
/**
...
var EquipmentsApi = /** @class */ (function (_super) {
     ...
     * @memberof EquipmentsApi
     */
    EquipmentsApi.prototype.apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut = function (hospitalId, equipmentId, updateEquipmentCommand, options) {
        return exports.EquipmentsApiFp(this.configuration).apiV1HospitalsHospitalIdEquipmentsEquipmentIdPut(hospitalId, equipmentId, updateEquipmentCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/hospitals/1/equipments      {          \"name\": \"Afroasia ltd\",          \"description\": \"Medical equipment\",          \"medias\": [            {              \"mediaType\": 0,              \"url\": \"imageurl\",              \"description\": \"string\",                      \"order\": 0            }          ]      }
     * @summary Create an equipment and add to a hospital.
     ...
     * @memberof EquipmentsApi
     */
    EquipmentsApi.prototype.apiV1HospitalsHospitalIdEquipmentsPost = function (hospitalId, createEquipmentCommand, options) {
        return exports.EquipmentsApiFp(this.configuration).apiV1HospitalsHospitalIdEquipmentsPost(hospitalId, createEquipmentCommand, options)(this.axios, this.basePath);
    };
...
exports.HospitalReviewsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdReviewsPatientIdPut: function (hospitalId, patientId, updateHospitalReviewCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateHospitalReviewCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateHospitalReviewCommand !== undefined ? updateHospitalReviewCommand : {}) : (updateHospitalReviewCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdReviewsPost: function (hospitalId, patientId, createHospitalReviewCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createHospitalReviewCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createHospitalReviewCommand !== undefined ? createHospitalReviewCommand : {}) : (createHospitalReviewCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.HospitalReviewsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdReviewsPatientIdPut: function (hospitalId, patientId, updateHospitalReviewCommand, options) {
            var localVarAxiosArgs = exports.HospitalReviewsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdReviewsPatientIdPut(hospitalId, patientId, updateHospitalReviewCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdReviewsPost: function (hospitalId, patientId, createHospitalReviewCommand, options) {
            var localVarAxiosArgs = exports.HospitalReviewsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdReviewsPost(hospitalId, patientId, createHospitalReviewCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalReviewsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdReviewsPatientIdPut: function (hospitalId, patientId, updateHospitalReviewCommand, options) {
            return exports.HospitalReviewsApiFp(configuration).apiV1HospitalsHospitalIdReviewsPatientIdPut(hospitalId, patientId, updateHospitalReviewCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/hospitals/1/reviews/1
         * @summary Create review.
         ...
         */
        apiV1HospitalsHospitalIdReviewsPost: function (hospitalId, patientId, createHospitalReviewCommand, options) {
            return exports.HospitalReviewsApiFp(configuration).apiV1HospitalsHospitalIdReviewsPost(hospitalId, patientId, createHospitalReviewCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/reviews
         * @summary Get all reviews.
...
var HospitalReviewsApi = /** @class */ (function (_super) {
     ...
     * @memberof HospitalReviewsApi
     */
    HospitalReviewsApi.prototype.apiV1HospitalsHospitalIdReviewsPatientIdPut = function (hospitalId, patientId, updateHospitalReviewCommand, options) {
        return exports.HospitalReviewsApiFp(this.configuration).apiV1HospitalsHospitalIdReviewsPatientIdPut(hospitalId, patientId, updateHospitalReviewCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/hospitals/1/reviews/1
     * @summary Create review.
     ...
     * @memberof HospitalReviewsApi
     */
    HospitalReviewsApi.prototype.apiV1HospitalsHospitalIdReviewsPost = function (hospitalId, patientId, createHospitalReviewCommand, options) {
        return exports.HospitalReviewsApiFp(this.configuration).apiV1HospitalsHospitalIdReviewsPost(hospitalId, patientId, createHospitalReviewCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/reviews
     * @summary Get all reviews.
...
exports.HospitalSpecialtiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdSpecialtysequencePut: function (hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateHospitalSpecialtySequenceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateHospitalSpecialtySequenceCommand !== undefined ? updateHospitalSpecialtySequenceCommand : {}) : (updateHospitalSpecialtySequenceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.HospitalSpecialtiesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdSpecialtysequencePut: function (hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options) {
            var localVarAxiosArgs = exports.HospitalSpecialtiesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdSpecialtysequencePut(hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalSpecialtiesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdSpecialtysequencePut: function (hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options) {
            return exports.HospitalSpecialtiesApiFp(configuration).apiV1HospitalsHospitalIdSpecialtysequencePut(hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/specialties
         * @summary Get all hospitalSpecialties.
...
var HospitalSpecialtiesApi = /** @class */ (function (_super) {
     ...
     * @memberof HospitalSpecialtiesApi
     */
    HospitalSpecialtiesApi.prototype.apiV1HospitalsHospitalIdSpecialtysequencePut = function (hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options) {
        return exports.HospitalSpecialtiesApiFp(this.configuration).apiV1HospitalsHospitalIdSpecialtysequencePut(hospitalId, specialtyTypeId, updateHospitalSpecialtySequenceCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/specialties
     * @summary Get all hospitalSpecialties.
...
exports.HospitalsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1HospitalsHospitalIdPut: function (hospitalId, updateHospitalCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateHospitalCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateHospitalCommand !== undefined ? updateHospitalCommand : {}) : (updateHospitalCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1HospitalsPost: function (createHospitalCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createHospitalCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createHospitalCommand !== undefined ? createHospitalCommand : {}) : (createHospitalCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.HospitalsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdPut: function (hospitalId, updateHospitalCommand, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdPut(hospitalId, updateHospitalCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsPost: function (createHospitalCommand, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsPost(createHospitalCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdPut: function (hospitalId, updateHospitalCommand, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsHospitalIdPut(hospitalId, updateHospitalCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/hospitals      {          \"name\": \"Samsung Medical Center\",          \"description\": \"Comprehensive Cancer Center in Seoul, South Korea is nationally ranked in 1 adult specialty.\",          \"logo\": \"http://www.samsunghospital.com/home/main/index.do\",          \"overview\": \"Overview of Samsung Medical Center\",          \"bedsCount\": 1436,          \"operationsPerYear\": 34,          \"foundationYear\": 2012,          \"departmentsCount\": 20,          \"medicalStaffCount\": 600,          \"countryId\": 1,          \"awards\": [            {              \"name\": \"Award1\",              \"image\": \"string\",              \"date\": \"2020-02-05T09:29:19.240Z\"            },            {              \"name\": \"Award2\",              \"image\": \"string\",              \"date\": \"2020-02-05T09:29:19.240Z\"            }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"https://cloudhospitalblob.blob.core.windows.net/imagecontainer/SamsungMedicalCenter.jpg\",              \"thumbnailUrl\": \"https://cloudhospitalblob.blob.core.windows.net/thumbnailcontainer/SamsungMedicalCenter.jpg\",              \"description\": \"string\",              \"order\": 0            },            {              \"mediaType\": \"Video\",              \"url\": \"string\",              \"description\": \"string\",              \"order\": 1            }          ],          \"location\": {            \"latitude\": 37.4881568,            \"longitude\": 127.0855952,            \"country\": \"Korea\",            \"state\": \"string\",            \"county\": \"Gangnamgu\",            \"city\": \"Seoul\",            \"zipCode\": \"12345\",            \"address\": \"Il-won ro 81\"          }      }
         * @summary Create a hospital.
         ...
         */
        apiV1HospitalsPost: function (createHospitalCommand, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsPost(createHospitalCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get hospital by slug.
...
var HospitalsApi = /** @class */ (function (_super) {
    ...
    HospitalsApi.prototype.apiV1HospitalsHospitalIdPut = function (hospitalId, updateHospitalCommand, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsHospitalIdPut(hospitalId, updateHospitalCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/hospitals      {          \"name\": \"Samsung Medical Center\",          \"description\": \"Comprehensive Cancer Center in Seoul, South Korea is nationally ranked in 1 adult specialty.\",          \"logo\": \"http://www.samsunghospital.com/home/main/index.do\",          \"overview\": \"Overview of Samsung Medical Center\",          \"bedsCount\": 1436,          \"operationsPerYear\": 34,          \"foundationYear\": 2012,          \"departmentsCount\": 20,          \"medicalStaffCount\": 600,          \"countryId\": 1,          \"awards\": [            {              \"name\": \"Award1\",              \"image\": \"string\",              \"date\": \"2020-02-05T09:29:19.240Z\"            },            {              \"name\": \"Award2\",              \"image\": \"string\",              \"date\": \"2020-02-05T09:29:19.240Z\"            }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"https://cloudhospitalblob.blob.core.windows.net/imagecontainer/SamsungMedicalCenter.jpg\",              \"thumbnailUrl\": \"https://cloudhospitalblob.blob.core.windows.net/thumbnailcontainer/SamsungMedicalCenter.jpg\",              \"description\": \"string\",              \"order\": 0            },            {              \"mediaType\": \"Video\",              \"url\": \"string\",              \"description\": \"string\",              \"order\": 1            }          ],          \"location\": {            \"latitude\": 37.4881568,            \"longitude\": 127.0855952,            \"country\": \"Korea\",            \"state\": \"string\",            \"county\": \"Gangnamgu\",            \"city\": \"Seoul\",            \"zipCode\": \"12345\",            \"address\": \"Il-won ro 81\"          }      }
     * @summary Create a hospital.
     ...
     * @memberof HospitalsApi
     */
    HospitalsApi.prototype.apiV1HospitalsPost = function (createHospitalCommand, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsPost(createHospitalCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get hospital by slug.
...
exports.ManagersApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1ManagersManagerIdPut: function (managerId, updateManagerCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateManagerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateManagerCommand !== undefined ? updateManagerCommand : {}) : (updateManagerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1ManagersPost: function (createManagerCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createManagerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createManagerCommand !== undefined ? createManagerCommand : {}) : (createManagerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ManagersManagerIdPut: function (managerId, updateManagerCommand, options) {
            var localVarAxiosArgs = exports.ManagersApiAxiosParamCreator(configuration).apiV1ManagersManagerIdPut(managerId, updateManagerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ManagersPost: function (createManagerCommand, options) {
            var localVarAxiosArgs = exports.ManagersApiAxiosParamCreator(configuration).apiV1ManagersPost(createManagerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ManagersManagerIdPut: function (managerId, updateManagerCommand, options) {
            return exports.ManagersApiFp(configuration).apiV1ManagersManagerIdPut(managerId, updateManagerCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/managers      {          \"userName\": \"manager\",          \"email\": \"manger@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create hospital manager.
         ...
         */
        apiV1ManagersPost: function (createManagerCommand, options) {
            return exports.ManagersApiFp(configuration).apiV1ManagersPost(createManagerCommand, options)(axios, basePath);
        },
    };
};
/**
...
var ManagersApi = /** @class */ (function (_super) {
    ...
    ManagersApi.prototype.apiV1ManagersManagerIdPut = function (managerId, updateManagerCommand, options) {
        return exports.ManagersApiFp(this.configuration).apiV1ManagersManagerIdPut(managerId, updateManagerCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/managers      {          \"userName\": \"manager\",          \"email\": \"manger@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create hospital manager.
    ...
    ManagersApi.prototype.apiV1ManagersPost = function (createManagerCommand, options) {
        return exports.ManagersApiFp(this.configuration).apiV1ManagersPost(createManagerCommand, options)(this.axios, this.basePath);
    };
    return ManagersApi;
}(base_1.BaseAPI));
...
exports.PartnersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PartnersPartnerIdPut: function (partnerId, updatePartnerCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'partnerId' is not null or undefined
            if (partnerId === null || partnerId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updatePartnerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updatePartnerCommand !== undefined ? updatePartnerCommand : {}) : (updatePartnerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1PartnersPost: function (createPartnerCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/partners";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createPartnerCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createPartnerCommand !== undefined ? createPartnerCommand : {}) : (createPartnerCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.PartnersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PartnersPartnerIdPut: function (partnerId, updatePartnerCommand, options) {
            var localVarAxiosArgs = exports.PartnersApiAxiosParamCreator(configuration).apiV1PartnersPartnerIdPut(partnerId, updatePartnerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1PartnersPost: function (createPartnerCommand, options) {
            var localVarAxiosArgs = exports.PartnersApiAxiosParamCreator(configuration).apiV1PartnersPost(createPartnerCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PartnersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PartnersPartnerIdPut: function (partnerId, updatePartnerCommand, options) {
            return exports.PartnersApiFp(configuration).apiV1PartnersPartnerIdPut(partnerId, updatePartnerCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/partners      {          \"userName\": \"string\",          \"email\": \"string\",          \"firstName\": \"string\",          \"lastName\": \"string\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T18:04:18.025Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create partner.
         ...
         */
        apiV1PartnersPost: function (createPartnerCommand, options) {
            return exports.PartnersApiFp(configuration).apiV1PartnersPost(createPartnerCommand, options)(axios, basePath);
        },
    };
};
/**
...
var PartnersApi = /** @class */ (function (_super) {
     ...
     * @memberof PartnersApi
     */
    PartnersApi.prototype.apiV1PartnersPartnerIdPut = function (partnerId, updatePartnerCommand, options) {
        return exports.PartnersApiFp(this.configuration).apiV1PartnersPartnerIdPut(partnerId, updatePartnerCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/partners      {          \"userName\": \"string\",          \"email\": \"string\",          \"firstName\": \"string\",          \"lastName\": \"string\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T18:04:18.025Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create partner.
     ...
     * @memberof PartnersApi
     */
    PartnersApi.prototype.apiV1PartnersPost = function (createPartnerCommand, options) {
        return exports.PartnersApiFp(this.configuration).apiV1PartnersPost(createPartnerCommand, options)(this.axios, this.basePath);
    };
    return PartnersApi;
}(base_1.BaseAPI));
...
exports.PatientsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1PatientsPatientIdPut: function (patientId, updatePatientCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updatePatientCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updatePatientCommand !== undefined ? updatePatientCommand : {}) : (updatePatientCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1PatientsPost: function (createPatientCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createPatientCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createPatientCommand !== undefined ? createPatientCommand : {}) : (createPatientCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.PatientsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PatientsPatientIdPut: function (patientId, updatePatientCommand, options) {
            var localVarAxiosArgs = exports.PatientsApiAxiosParamCreator(configuration).apiV1PatientsPatientIdPut(patientId, updatePatientCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1PatientsPost: function (createPatientCommand, options) {
            var localVarAxiosArgs = exports.PatientsApiAxiosParamCreator(configuration).apiV1PatientsPost(createPatientCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PatientsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PatientsPatientIdPut: function (patientId, updatePatientCommand, options) {
            return exports.PatientsApiFp(configuration).apiV1PatientsPatientIdPut(patientId, updatePatientCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/patients      {          \"referralCode\": \"123456\",          \"email\": \"patient@icloudhospital.com\",          \"firstName\": \"patient\",          \"lastName\": \"cloud\",          \"photo\": \"string\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create patient.
         ...
         */
        apiV1PatientsPost: function (createPatientCommand, options) {
            return exports.PatientsApiFp(configuration).apiV1PatientsPost(createPatientCommand, options)(axios, basePath);
        },
    };
};
/**
...
var PatientsApi = /** @class */ (function (_super) {
    ...
    PatientsApi.prototype.apiV1PatientsPatientIdPut = function (patientId, updatePatientCommand, options) {
        return exports.PatientsApiFp(this.configuration).apiV1PatientsPatientIdPut(patientId, updatePatientCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/patients      {          \"referralCode\": \"123456\",          \"email\": \"patient@icloudhospital.com\",          \"firstName\": \"patient\",          \"lastName\": \"cloud\",          \"photo\": \"string\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create patient.
    ...
    PatientsApi.prototype.apiV1PatientsPost = function (createPatientCommand, options) {
        return exports.PatientsApiFp(this.configuration).apiV1PatientsPost(createPatientCommand, options)(this.axios, this.basePath);
    };
    return PatientsApi;
}(base_1.BaseAPI));
...
exports.ProfilesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1ProfilesChangeemailPost: function (changeEmailCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof changeEmailCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(changeEmailCommand !== undefined ? changeEmailCommand : {}) : (changeEmailCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1ProfilesConfirmemailPost: function (confirmEmailCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof confirmEmailCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(confirmEmailCommand !== undefined ? confirmEmailCommand : {}) : (confirmEmailCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ProfilesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ProfilesChangeemailPost: function (changeEmailCommand, options) {
            var localVarAxiosArgs = exports.ProfilesApiAxiosParamCreator(configuration).apiV1ProfilesChangeemailPost(changeEmailCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ProfilesConfirmemailPost: function (confirmEmailCommand, options) {
            var localVarAxiosArgs = exports.ProfilesApiAxiosParamCreator(configuration).apiV1ProfilesConfirmemailPost(confirmEmailCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ProfilesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ProfilesChangeemailPost: function (changeEmailCommand, options) {
            return exports.ProfilesApiFp(configuration).apiV1ProfilesChangeemailPost(changeEmailCommand, options)(axios, basePath);
        },
        /**
         *
         * @param {ConfirmEmailCommand} [confirmEmailCommand]
         ...
         */
        apiV1ProfilesConfirmemailPost: function (confirmEmailCommand, options) {
            return exports.ProfilesApiFp(configuration).apiV1ProfilesConfirmemailPost(confirmEmailCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/profiles
         * @summary Get current user\'s profile.
...
var ProfilesApi = /** @class */ (function (_super) {
    ...
    ProfilesApi.prototype.apiV1ProfilesChangeemailPost = function (changeEmailCommand, options) {
        return exports.ProfilesApiFp(this.configuration).apiV1ProfilesChangeemailPost(changeEmailCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {ConfirmEmailCommand} [confirmEmailCommand]
    ...
    ProfilesApi.prototype.apiV1ProfilesConfirmemailPost = function (confirmEmailCommand, options) {
        return exports.ProfilesApiFp(this.configuration).apiV1ProfilesConfirmemailPost(confirmEmailCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/profiles
     * @summary Get current user\'s profile.
...
exports.QuestionCommentsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (questionId, createQuestionCommentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'questionId' is not null or undefined
            if (questionId === null || questionId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createQuestionCommentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createQuestionCommentCommand !== undefined ? createQuestionCommentCommand : {}) : (createQuestionCommentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (questionId, questionCommentId, updateQuestionCommentCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'questionId' is not null or undefined
            if (questionId === null || questionId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateQuestionCommentCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateQuestionCommentCommand !== undefined ? updateQuestionCommentCommand : {}) : (updateQuestionCommentCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.QuestionCommentsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (questionId, createQuestionCommentCommand, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(questionId, createQuestionCommentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (questionId, questionCommentId, updateQuestionCommentCommand, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(questionId, questionCommentId, updateQuestionCommentCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.QuestionCommentsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (questionId, createQuestionCommentCommand, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(questionId, createQuestionCommentCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/questions/1/questionComments/1
         * @summary Delete questionComment.
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (questionId, questionCommentId, updateQuestionCommentCommand, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(questionId, questionCommentId, updateQuestionCommentCommand, options)(axios, basePath);
        },
    };
};
/**
...
var QuestionCommentsApi = /** @class */ (function (_super) {
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsPost = function (questionId, createQuestionCommentCommand, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(questionId, createQuestionCommentCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/questions/1/questionComments/1
     * @summary Delete questionComment.
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut = function (questionId, questionCommentId, updateQuestionCommentCommand, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(questionId, questionCommentId, updateQuestionCommentCommand, options)(this.axios, this.basePath);
    };
...
exports.QuestionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdQuestionsPost: function (hospitalId, createQuestionCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createQuestionCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createQuestionCommand !== undefined ? createQuestionCommand : {}) : (createQuestionCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdQuestionsQuestionIdPut: function (hospitalId, questionId, updateQuestionCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateQuestionCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateQuestionCommand !== undefined ? updateQuestionCommand : {}) : (updateQuestionCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.QuestionsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdQuestionsPost: function (hospitalId, createQuestionCommand, options) {
            var localVarAxiosArgs = exports.QuestionsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdQuestionsPost(hospitalId, createQuestionCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdQuestionsQuestionIdPut: function (hospitalId, questionId, updateQuestionCommand, options) {
            var localVarAxiosArgs = exports.QuestionsApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdQuestionsQuestionIdPut(hospitalId, questionId, updateQuestionCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.QuestionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdQuestionsPost: function (hospitalId, createQuestionCommand, options) {
            return exports.QuestionsApiFp(configuration).apiV1HospitalsHospitalIdQuestionsPost(hospitalId, createQuestionCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/questions/1
         * @summary Delete question.
         ...
         */
        apiV1HospitalsHospitalIdQuestionsQuestionIdPut: function (hospitalId, questionId, updateQuestionCommand, options) {
            return exports.QuestionsApiFp(configuration).apiV1HospitalsHospitalIdQuestionsQuestionIdPut(hospitalId, questionId, updateQuestionCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/1/questions
         * @summary Get all questions.
...
var QuestionsApi = /** @class */ (function (_super) {
     ...
     */
    QuestionsApi.prototype.apiV1HospitalsHospitalIdQuestionsPost = function (hospitalId, createQuestionCommand, options) {
        return exports.QuestionsApiFp(this.configuration).apiV1HospitalsHospitalIdQuestionsPost(hospitalId, createQuestionCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/questions/1
     * @summary Delete question.
     ...
     * @memberof QuestionsApi
     */
    QuestionsApi.prototype.apiV1HospitalsHospitalIdQuestionsQuestionIdPut = function (hospitalId, questionId, updateQuestionCommand, options) {
        return exports.QuestionsApiFp(this.configuration).apiV1HospitalsHospitalIdQuestionsQuestionIdPut(hospitalId, questionId, updateQuestionCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/1/questions
     * @summary Get all questions.
...
exports.ServiceCategoriesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ServicecategoriesPost: function (createServiceCategoryCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/servicecategories";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createServiceCategoryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createServiceCategoryCommand !== undefined ? createServiceCategoryCommand : {}) : (createServiceCategoryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1ServicecategoriesServiceCategoryIdPut: function (serviceCategoryId, updateServiceCategoryCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'serviceCategoryId' is not null or undefined
            if (serviceCategoryId === null || serviceCategoryId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateServiceCategoryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateServiceCategoryCommand !== undefined ? updateServiceCategoryCommand : {}) : (updateServiceCategoryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ServiceCategoriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ServicecategoriesPost: function (createServiceCategoryCommand, options) {
            var localVarAxiosArgs = exports.ServiceCategoriesApiAxiosParamCreator(configuration).apiV1ServicecategoriesPost(createServiceCategoryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ServicecategoriesServiceCategoryIdPut: function (serviceCategoryId, updateServiceCategoryCommand, options) {
            var localVarAxiosArgs = exports.ServiceCategoriesApiAxiosParamCreator(configuration).apiV1ServicecategoriesServiceCategoryIdPut(serviceCategoryId, updateServiceCategoryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServiceCategoriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ServicecategoriesPost: function (createServiceCategoryCommand, options) {
            return exports.ServiceCategoriesApiFp(configuration).apiV1ServicecategoriesPost(createServiceCategoryCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/ServiceCategories/1
         * @summary Delete ServiceCategory.
         ...
         */
        apiV1ServicecategoriesServiceCategoryIdPut: function (serviceCategoryId, updateServiceCategoryCommand, options) {
            return exports.ServiceCategoriesApiFp(configuration).apiV1ServicecategoriesServiceCategoryIdPut(serviceCategoryId, updateServiceCategoryCommand, options)(axios, basePath);
        },
    };
};
/**
...
var ServiceCategoriesApi = /** @class */ (function (_super) {
     ...
     * @memberof ServiceCategoriesApi
     */
    ServiceCategoriesApi.prototype.apiV1ServicecategoriesPost = function (createServiceCategoryCommand, options) {
        return exports.ServiceCategoriesApiFp(this.configuration).apiV1ServicecategoriesPost(createServiceCategoryCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/ServiceCategories/1
     * @summary Delete ServiceCategory.
     ...
     * @memberof ServiceCategoriesApi
     */
    ServiceCategoriesApi.prototype.apiV1ServicecategoriesServiceCategoryIdPut = function (serviceCategoryId, updateServiceCategoryCommand, options) {
        return exports.ServiceCategoriesApiFp(this.configuration).apiV1ServicecategoriesServiceCategoryIdPut(serviceCategoryId, updateServiceCategoryCommand, options)(this.axios, this.basePath);
    };
...
exports.ServicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost: function (hospitalId, specialtyId, createServiceCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createServiceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createServiceCommand !== undefined ? createServiceCommand : {}) : (createServiceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut: function (hospitalId, specialtyId, serviceId, updateServiceCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateServiceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateServiceCommand !== undefined ? updateServiceCommand : {}) : (updateServiceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut: function (hospitalId, specialtyId, updateServiceSequenceCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateServiceSequenceCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateServiceSequenceCommand !== undefined ? updateServiceSequenceCommand : {}) : (updateServiceSequenceCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.ServicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost: function (hospitalId, specialtyId, createServiceCommand, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost(hospitalId, specialtyId, createServiceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut: function (hospitalId, specialtyId, serviceId, updateServiceCommand, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut(hospitalId, specialtyId, serviceId, updateServiceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut: function (hospitalId, specialtyId, updateServiceSequenceCommand, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut(hospitalId, specialtyId, updateServiceSequenceCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost: function (hospitalId, specialtyId, createServiceCommand, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost(hospitalId, specialtyId, createServiceCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/specialties/1/services/1
         * @summary Delete service.
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut: function (hospitalId, specialtyId, serviceId, updateServiceCommand, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut(hospitalId, specialtyId, serviceId, updateServiceCommand, options)(axios, basePath);
        },
        /**
         * Smaple request:        PUT /api/v1/hospitals/1/specialties/1/servicesquence      {          \"serviceSequence\": [1, 3, 5]      }
         * @summary Update service sequence.
         ...
         */
        apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut: function (hospitalId, specialtyId, updateServiceSequenceCommand, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut(hospitalId, specialtyId, updateServiceSequenceCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/services
         * @summary Get all services.
...
var ServicesApi = /** @class */ (function (_super) {
     ...
     */
    ServicesApi.prototype.apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost = function (hospitalId, specialtyId, createServiceCommand, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesPost(hospitalId, specialtyId, createServiceCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/specialties/1/services/1
     * @summary Delete service.
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut = function (hospitalId, specialtyId, serviceId, updateServiceCommand, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesServiceIdPut(hospitalId, specialtyId, serviceId, updateServiceCommand, options)(this.axios, this.basePath);
    };
    /**
     * Smaple request:        PUT /api/v1/hospitals/1/specialties/1/servicesquence      {          \"serviceSequence\": [1, 3, 5]      }
     * @summary Update service sequence.
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut = function (hospitalId, specialtyId, updateServiceSequenceCommand, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsHospitalIdSpecialtiesSpecialtyIdServicesquencePut(hospitalId, specialtyId, updateServiceSequenceCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/services
     * @summary Get all services.
...
exports.SpecialtiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtiesPost: function (specialtyTypeId, createSpecialtyCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/specialties";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createSpecialtyCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createSpecialtyCommand !== undefined ? createSpecialtyCommand : {}) : (createSpecialtyCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1SpecialtiesSlugsSlugGet: function (slug, options) {
            ...
            var localVarPath = "/api/v1/specialties/slugs/{slug}"
                .replace("{" + "slug" + "}", encodeURIComponent(String(slug)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
        ...
        apiV1SpecialtiesSpecialtyIdPut: function (specialtyId, updateSpecialtyCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateSpecialtyCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateSpecialtyCommand !== undefined ? updateSpecialtyCommand : {}) : (updateSpecialtyCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.SpecialtiesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtiesPost: function (specialtyTypeId, createSpecialtyCommand, options) {
            var localVarAxiosArgs = exports.SpecialtiesApiAxiosParamCreator(configuration).apiV1SpecialtiesPost(specialtyTypeId, createSpecialtyCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SpecialtiesSlugsSlugGet: function (slug, options) {
            var localVarAxiosArgs = exports.SpecialtiesApiAxiosParamCreator(configuration).apiV1SpecialtiesSlugsSlugGet(slug, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SpecialtiesSpecialtyIdPut: function (specialtyId, updateSpecialtyCommand, options) {
            var localVarAxiosArgs = exports.SpecialtiesApiAxiosParamCreator(configuration).apiV1SpecialtiesSpecialtyIdPut(specialtyId, updateSpecialtyCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtiesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtiesPost: function (specialtyTypeId, createSpecialtyCommand, options) {
            return exports.SpecialtiesApiFp(configuration).apiV1SpecialtiesPost(specialtyTypeId, createSpecialtyCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get specialty by slug.
         ...
         */
        apiV1SpecialtiesSlugsSlugGet: function (slug, options) {
            return exports.SpecialtiesApiFp(configuration).apiV1SpecialtiesSlugsSlugGet(slug, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/specialties/1
         * @summary Delete specialty.
         ...
         */
        apiV1SpecialtiesSpecialtyIdPut: function (specialtyId, updateSpecialtyCommand, options) {
            return exports.SpecialtiesApiFp(configuration).apiV1SpecialtiesSpecialtyIdPut(specialtyId, updateSpecialtyCommand, options)(axios, basePath);
        },
    };
};
/**
...
var SpecialtiesApi = /** @class */ (function (_super) {
     ...
     * @memberof SpecialtiesApi
     */
    SpecialtiesApi.prototype.apiV1SpecialtiesPost = function (specialtyTypeId, createSpecialtyCommand, options) {
        return exports.SpecialtiesApiFp(this.configuration).apiV1SpecialtiesPost(specialtyTypeId, createSpecialtyCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get specialty by slug.
    ...
    SpecialtiesApi.prototype.apiV1SpecialtiesSlugsSlugGet = function (slug, options) {
        return exports.SpecialtiesApiFp(this.configuration).apiV1SpecialtiesSlugsSlugGet(slug, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/specialties/1
     * @summary Delete specialty.
     ...
     * @memberof SpecialtiesApi
     */
    SpecialtiesApi.prototype.apiV1SpecialtiesSpecialtyIdPut = function (specialtyId, updateSpecialtyCommand, options) {
        return exports.SpecialtiesApiFp(this.configuration).apiV1SpecialtiesSpecialtyIdPut(specialtyId, updateSpecialtyCommand, options)(this.axios, this.basePath);
    };
...
exports.SpecialtyTypeCategoriesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypecategoriesPost: function (createSpecialtyTypeCategoryCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/specialtytypecategories";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createSpecialtyTypeCategoryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createSpecialtyTypeCategoryCommand !== undefined ? createSpecialtyTypeCategoryCommand : {}) : (createSpecialtyTypeCategoryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut: function (specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'specialtyTypeCategoryId' is not null or undefined
            if (specialtyTypeCategoryId === null || specialtyTypeCategoryId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateSpecialtyTypeCategoryCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateSpecialtyTypeCategoryCommand !== undefined ? updateSpecialtyTypeCategoryCommand : {}) : (updateSpecialtyTypeCategoryCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.SpecialtyTypeCategoriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtytypecategoriesPost: function (createSpecialtyTypeCategoryCommand, options) {
            var localVarAxiosArgs = exports.SpecialtyTypeCategoriesApiAxiosParamCreator(configuration).apiV1SpecialtytypecategoriesPost(createSpecialtyTypeCategoryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut: function (specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options) {
            var localVarAxiosArgs = exports.SpecialtyTypeCategoriesApiAxiosParamCreator(configuration).apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut(specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtyTypeCategoriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtytypecategoriesPost: function (createSpecialtyTypeCategoryCommand, options) {
            return exports.SpecialtyTypeCategoriesApiFp(configuration).apiV1SpecialtytypecategoriesPost(createSpecialtyTypeCategoryCommand, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/SpecialtyTypeCategories/1
         * @summary Delete specialtyTypeCategory.
         ...
         */
        apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut: function (specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options) {
            return exports.SpecialtyTypeCategoriesApiFp(configuration).apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut(specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options)(axios, basePath);
        },
    };
};
/**
...
var SpecialtyTypeCategoriesApi = /** @class */ (function (_super) {
     ...
     * @memberof SpecialtyTypeCategoriesApi
     */
    SpecialtyTypeCategoriesApi.prototype.apiV1SpecialtytypecategoriesPost = function (createSpecialtyTypeCategoryCommand, options) {
        return exports.SpecialtyTypeCategoriesApiFp(this.configuration).apiV1SpecialtytypecategoriesPost(createSpecialtyTypeCategoryCommand, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/SpecialtyTypeCategories/1
     * @summary Delete specialtyTypeCategory.
     ...
     * @memberof SpecialtyTypeCategoriesApi
     */
    SpecialtyTypeCategoriesApi.prototype.apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut = function (specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options) {
        return exports.SpecialtyTypeCategoriesApiFp(this.configuration).apiV1SpecialtytypecategoriesSpecialtyTypeCategoryIdPut(specialtyTypeCategoryId, updateSpecialtyTypeCategoryCommand, options)(this.axios, this.basePath);
    };
...
exports.SpecialtyTypesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypesPost: function (specialtyTypeId, createSpecialtyTypeCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/specialtytypes";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createSpecialtyTypeCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createSpecialtyTypeCommand !== undefined ? createSpecialtyTypeCommand : {}) : (createSpecialtyTypeCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        apiV1SpecialtytypesSpecialtyTypeIdPut: function (specialtyTypeId, updateSpecialtyTypeCommand, options) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateSpecialtyTypeCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateSpecialtyTypeCommand !== undefined ? updateSpecialtyTypeCommand : {}) : (updateSpecialtyTypeCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.SpecialtyTypesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtytypesPost: function (specialtyTypeId, createSpecialtyTypeCommand, options) {
            var localVarAxiosArgs = exports.SpecialtyTypesApiAxiosParamCreator(configuration).apiV1SpecialtytypesPost(specialtyTypeId, createSpecialtyTypeCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SpecialtytypesSpecialtyTypeIdPut: function (specialtyTypeId, updateSpecialtyTypeCommand, options) {
            var localVarAxiosArgs = exports.SpecialtyTypesApiAxiosParamCreator(configuration).apiV1SpecialtytypesSpecialtyTypeIdPut(specialtyTypeId, updateSpecialtyTypeCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtyTypesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtytypesPost: function (specialtyTypeId, createSpecialtyTypeCommand, options) {
            return exports.SpecialtyTypesApiFp(configuration).apiV1SpecialtytypesPost(specialtyTypeId, createSpecialtyTypeCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get specialtyType by slug.
         ...
         */
        apiV1SpecialtytypesSpecialtyTypeIdPut: function (specialtyTypeId, updateSpecialtyTypeCommand, options) {
            return exports.SpecialtyTypesApiFp(configuration).apiV1SpecialtytypesSpecialtyTypeIdPut(specialtyTypeId, updateSpecialtyTypeCommand, options)(axios, basePath);
        },
    };
};
/**
...
var SpecialtyTypesApi = /** @class */ (function (_super) {
     ...
     * @memberof SpecialtyTypesApi
     */
    SpecialtyTypesApi.prototype.apiV1SpecialtytypesPost = function (specialtyTypeId, createSpecialtyTypeCommand, options) {
        return exports.SpecialtyTypesApiFp(this.configuration).apiV1SpecialtytypesPost(specialtyTypeId, createSpecialtyTypeCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get specialtyType by slug.
    ...
    SpecialtyTypesApi.prototype.apiV1SpecialtytypesSpecialtyTypeIdPut = function (specialtyTypeId, updateSpecialtyTypeCommand, options) {
        return exports.SpecialtyTypesApiFp(this.configuration).apiV1SpecialtytypesSpecialtyTypeIdPut(specialtyTypeId, updateSpecialtyTypeCommand, options)(this.axios, this.basePath);
    };
...
exports.YoutubesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1YoutubesPost: function (createYoutubeCommand, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/youtubes";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof createYoutubeCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(createYoutubeCommand !== undefined ? createYoutubeCommand : {}) : (createYoutubeCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1YoutubesYoutubeIdPut: function (youtubeId, updateYoutubeCommand, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'youtubeId' is not null or undefined
            if (youtubeId === null || youtubeId === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof updateYoutubeCommand !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data = needsSerialization ? JSON.stringify(updateYoutubeCommand !== undefined ? updateYoutubeCommand : {}) : (updateYoutubeCommand || "");
            return {
                url: globalImportUrl.format(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.YoutubesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1YoutubesPost: function (createYoutubeCommand, options) {
            var localVarAxiosArgs = exports.YoutubesApiAxiosParamCreator(configuration).apiV1YoutubesPost(createYoutubeCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1YoutubesYoutubeIdPut: function (youtubeId, updateYoutubeCommand, options) {
            var localVarAxiosArgs = exports.YoutubesApiAxiosParamCreator(configuration).apiV1YoutubesYoutubeIdPut(youtubeId, updateYoutubeCommand, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.YoutubesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1YoutubesPost: function (createYoutubeCommand, options) {
            return exports.YoutubesApiFp(configuration).apiV1YoutubesPost(createYoutubeCommand, options)(axios, basePath);
        },
        /**
         *
         * @summary Get youtube by slug.
         ...
         */
        apiV1YoutubesYoutubeIdPut: function (youtubeId, updateYoutubeCommand, options) {
            return exports.YoutubesApiFp(configuration).apiV1YoutubesYoutubeIdPut(youtubeId, updateYoutubeCommand, options)(axios, basePath);
        },
    };
};
/**
...
var YoutubesApi = /** @class */ (function (_super) {
     ...
     * @memberof YoutubesApi
     */
    YoutubesApi.prototype.apiV1YoutubesPost = function (createYoutubeCommand, options) {
        return exports.YoutubesApiFp(this.configuration).apiV1YoutubesPost(createYoutubeCommand, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get youtube by slug.
     ...
     * @memberof YoutubesApi
     */
    YoutubesApi.prototype.apiV1YoutubesYoutubeIdPut = function (youtubeId, updateYoutubeCommand, options) {
        return exports.YoutubesApiFp(this.configuration).apiV1YoutubesYoutubeIdPut(youtubeId, updateYoutubeCommand, options)(this.axios, this.basePath);
    };
    return YoutubesApi;
}(base_1.BaseAPI));
