...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsPublickeyGet: function (options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/bookings/publickey";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsPublickeyGet: function (options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsPublickeyGet(options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsPublickeyGet: function (options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsPublickeyGet(options)(axios, basePath);
        },
    };
};
/**
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsPublickeyGet = function (options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsPublickeyGet(options)(this.axios, this.basePath);
    };
    return BookingsApi;
}(base_1.BaseAPI));
...
exports.ConsultationsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        apiV1ConsultationsConsultationIdPaidPost: function (consultationId, options) {
            ...
            // verify required parameter 'consultationId' is not null or undefined
            if (consultationId === null || consultationId === undefined) {
                throw new base_1.RequiredError('consultationId', 'Required parameter consultationId was null or undefined when calling apiV1ConsultationsConsultationIdPaidPost.');
            }
            var localVarPath = "/api/v1/consultations/{consultationId}/paid"
                .replace("{" + "consultationId" + "}", encodeURIComponent(String(consultationId)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsPublickeyGet: function (options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/consultations/publickey";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
exports.ConsultationsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdPaidPost: function (consultationId, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsConsultationIdPaidPost(consultationId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1ConsultationsPublickeyGet: function (options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsPublickeyGet(options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ConsultationsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdPaidPost: function (consultationId, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsConsultationIdPaidPost(consultationId, options)(axios, basePath);
        },
        /**
         *
         * @summary Pay consultation.
         ...
         */
        apiV1ConsultationsPublickeyGet: function (options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsPublickeyGet(options)(axios, basePath);
        },
    };
};
/**
...
var ConsultationsApi = /** @class */ (function (_super) {
    ...
    ConsultationsApi.prototype.apiV1ConsultationsConsultationIdPaidPost = function (consultationId, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsConsultationIdPaidPost(consultationId, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Pay consultation.
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsPublickeyGet = function (options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsPublickeyGet(options)(this.axios, this.basePath);
    };
