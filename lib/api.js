...
exports.ArticlesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ArticlesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ArticlesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/articles/1
         * @summary Delete article.
...
var ArticlesApi = /** @class */ (function (_super) {
     ...
     */
    ArticlesApi.prototype.apiV1HospitalsArticlesGet = function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, tag, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/articles/1
     * @summary Delete article.
