...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @summary Create booking.
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsGet = function (searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, status, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create booking.
...
exports.ConsultationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ConsultationsConsultationIdCancelPost: function (consultationId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'consultationId' is not null or undefined
            if (consultationId === null || consultationId === undefined) {
...
exports.ConsultationsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdCancelPost: function (consultationId, body, options) {
            var localVarAxiosArgs = exports.ConsultationsApiAxiosParamCreator(configuration).apiV1ConsultationsConsultationIdCancelPost(consultationId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ConsultationsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ConsultationsConsultationIdCancelPost: function (consultationId, body, options) {
            return exports.ConsultationsApiFp(configuration).apiV1ConsultationsConsultationIdCancelPost(consultationId, body, options)(axios, basePath);
        },
        /**
         *
         * @summary Delete consultation.
...
var ConsultationsApi = /** @class */ (function (_super) {
     ...
     * @memberof ConsultationsApi
     */
    ConsultationsApi.prototype.apiV1ConsultationsConsultationIdCancelPost = function (consultationId, body, options) {
        return exports.ConsultationsApiFp(this.configuration).apiV1ConsultationsConsultationIdCancelPost(consultationId, body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Delete consultation.
