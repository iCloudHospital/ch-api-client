...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdCancelPost: function (bookingId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdConsultGet: function (bookingId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
                throw new base_1.RequiredError('bookingId', 'Required parameter bookingId was null or undefined when calling apiV1BookingsBookingIdConsultGet.');
            }
            var localVarPath = "/api/v1/bookings/{bookingId}/consult"
                .replace("{" + "bookingId" + "}", encodeURIComponent(String(bookingId)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdConsultPut: function (bookingId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
                throw new base_1.RequiredError('bookingId', 'Required parameter bookingId was null or undefined when calling apiV1BookingsBookingIdConsultPut.');
            }
            var localVarPath = "/api/v1/bookings/{bookingId}/consult"
                .replace("{" + "bookingId" + "}", encodeURIComponent(String(bookingId)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdDealGet: function (bookingId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
                throw new base_1.RequiredError('bookingId', 'Required parameter bookingId was null or undefined when calling apiV1BookingsBookingIdDealGet.');
            }
            var localVarPath = "/api/v1/bookings/{bookingId}/deal"
                .replace("{" + "bookingId" + "}", encodeURIComponent(String(bookingId)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsBookingIdDealPut: function (bookingId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'bookingId' is not null or undefined
            if (bookingId === null || bookingId === undefined) {
                throw new base_1.RequiredError('bookingId', 'Required parameter bookingId was null or undefined when calling apiV1BookingsBookingIdDealPut.');
            }
            var localVarPath = "/api/v1/bookings/{bookingId}/deal"
                .replace("{" + "bookingId" + "}", encodeURIComponent(String(bookingId)));
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsConsultPost: function (body, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/bookings/consult";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsDealPost: function (body, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/bookings/deal";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsBookingIdCancelPost: function (bookingId, body, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdCancelPost(bookingId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdConsultGet: function (bookingId, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdConsultGet(bookingId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdConsultPut: function (bookingId, body, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdConsultPut(bookingId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdDealGet: function (bookingId, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdDealGet(bookingId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsBookingIdDealPut: function (bookingId, body, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsBookingIdDealPut(bookingId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsConsultPost: function (body, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsConsultPost(body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsDealPost: function (body, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsDealPost(body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsBookingIdCancelPost: function (bookingId, body, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdCancelPost(bookingId, body, options)(axios, basePath);
        },
        /**
         *
         * @summary Get consult booking.
         ...
         */
        apiV1BookingsBookingIdConsultGet: function (bookingId, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdConsultGet(bookingId, options)(axios, basePath);
        },
        /**
         *
         * @summary Update consult booking.
         ...
         */
        apiV1BookingsBookingIdConsultPut: function (bookingId, body, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdConsultPut(bookingId, body, options)(axios, basePath);
        },
        /**
         *
         * @summary Get deal booking.
         ...
         */
        apiV1BookingsBookingIdDealGet: function (bookingId, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdDealGet(bookingId, options)(axios, basePath);
        },
        /**
         *
         * @summary Update deal booking.
         ...
         */
        apiV1BookingsBookingIdDealPut: function (bookingId, body, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsBookingIdDealPut(bookingId, body, options)(axios, basePath);
        },
        /**
         *
         * @summary Delete booking.
         ...
         */
        apiV1BookingsConsultPost: function (body, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsConsultPost(body, options)(axios, basePath);
        },
        /**
         *
         * @summary Create deal booking.
         ...
         */
        apiV1BookingsDealPost: function (body, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsDealPost(body, options)(axios, basePath);
        },
        /**
         *
         * @summary Get all bookings.
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdCancelPost = function (bookingId, body, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdCancelPost(bookingId, body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get consult booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdConsultGet = function (bookingId, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdConsultGet(bookingId, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Update consult booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdConsultPut = function (bookingId, body, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdConsultPut(bookingId, body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get deal booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdDealGet = function (bookingId, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdDealGet(bookingId, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Update deal booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsBookingIdDealPut = function (bookingId, body, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsBookingIdDealPut(bookingId, body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Delete booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsConsultPost = function (body, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsConsultPost(body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create deal booking.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsDealPost = function (body, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsDealPost(body, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Get all bookings.
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsGet = function (searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsGet(searchString, isOpen, isCompleted, bookingType, bookingStatus, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return BookingsApi;
}(base_1.BaseAPI));
 ...
 * @export
 */
exports.DirectoriesApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
         ...
         * @throws {RequiredError}
         */
        apiV1DirectoriesCountriesGet: function (name, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/directories/countries";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
 ...
 * @export
 */
exports.DirectoriesApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Get all CountryCode.
         ...
         */
        apiV1DirectoriesCountriesGet: function (name, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DirectoriesApiAxiosParamCreator(configuration).apiV1DirectoriesCountriesGet(name, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
 ...
 * @export
 */
exports.DirectoriesApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @summary Get all CountryCode.
         ...
         */
        apiV1DirectoriesCountriesGet: function (name, page, limit, lastRetrieved, current, options) {
            return exports.DirectoriesApiFp(configuration).apiV1DirectoriesCountriesGet(name, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
 ...
 * @extends {BaseAPI}
 */
var DirectoriesApi = /** @class */ (function (_super) {
    __extends(DirectoriesApi, _super);
    function DirectoriesApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     *
     ...
     */
    DirectoriesApi.prototype.apiV1DirectoriesCountriesGet = function (name, page, limit, lastRetrieved, current, options) {
        return exports.DirectoriesApiFp(this.configuration).apiV1DirectoriesCountriesGet(name, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
...
exports.HospitalsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
         * @summary Get all hospitals.
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1
         * @summary Delete hospital.
...
var HospitalsApi = /** @class */ (function (_super) {
     ...
     */
    HospitalsApi.prototype.apiV1HospitalsCurrentGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
     * @summary Get all hospitals.
     ...
     * @memberof HospitalsApi
     */
    HospitalsApi.prototype.apiV1HospitalsGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, showHidden, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1
     * @summary Delete hospital.
