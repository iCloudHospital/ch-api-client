...
exports.ServicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ServicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var ServicesApi = /** @class */ (function (_super) {
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsServicesGet = function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, category, hasCategory, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return ServicesApi;
}(base_1.BaseAPI));
...
exports.SpecialtyTypesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SpecialtyTypesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SpecialtyTypesApiAxiosParamCreator(configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtyTypesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options) {
            return exports.SpecialtyTypesApiFp(configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/SpecialtyTypes      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyTypeType\": \"Cardiology\"      }
         * @summary Create specialtyType.
...
var SpecialtyTypesApi = /** @class */ (function (_super) {
     ...
     */
    SpecialtyTypesApi.prototype.apiV1SpecialtytypesGet = function (id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options) {
        return exports.SpecialtyTypesApiFp(this.configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, hasCategory, created, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/SpecialtyTypes      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyTypeType\": \"Cardiology\"      }
     * @summary Create specialtyType.
