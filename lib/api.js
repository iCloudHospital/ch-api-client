...
exports.SearchApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SearchGet: function (searchTerm, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/search";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
exports.SearchApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SearchGet: function (searchTerm, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchGet(searchTerm, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SearchApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SearchGet: function (searchTerm, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchGet(searchTerm, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var SearchApi = /** @class */ (function (_super) {
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchGet = function (searchTerm, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchGet(searchTerm, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return SearchApi;
}(base_1.BaseAPI));
