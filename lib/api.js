...
exports.ArticlesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ArticlesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ArticlesApiAxiosParamCreator(configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ArticlesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsArticlesGet: function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.ArticlesApiFp(configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/articles/1
         * @summary Delete article.
...
var ArticlesApi = /** @class */ (function (_super) {
     ...
     */
    ArticlesApi.prototype.apiV1HospitalsArticlesGet = function (id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.ArticlesApiFp(this.configuration).apiV1HospitalsArticlesGet(id, title, description, status, marketingType, userId, userName, hospitalId, hospitalName, countryId, tag, exceptHospitalId, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/articles/1
     * @summary Delete article.
...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsGet: function (page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options) {
            if (options === void 0) { options = {}; }
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsGet: function (page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsGet(page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsGet: function (page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsGet(page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/bookings      {          \"packageId\": 1,          \"approximateDateStart\": \"2020-02-28T06:21:09.698Z\",          \"approximateDateEnd\": \"2020-02-28T06:21:09.698Z\"      }
         * @summary Create a booking.
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsGet = function (page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsGet(page, limit, countOnly, lastRetrieved, current, searchString, isOpen, bookingStatus, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/bookings      {          \"packageId\": 1,          \"approximateDateStart\": \"2020-02-28T06:21:09.698Z\",          \"approximateDateEnd\": \"2020-02-28T06:21:09.698Z\"      }
     * @summary Create a booking.
...
exports.CHAdminsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChadminsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.CHAdminsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChadminsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.CHAdminsApiAxiosParamCreator(configuration).apiV1ChadminsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHAdminsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChadminsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.CHAdminsApiFp(configuration).apiV1ChadminsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/chadmins      {          \"firstName\": \"Cloud\",          \"lastName\": \"Hospital\",          \"photo\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"photoThumbnail\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T09:09:19.082Z\",          \"locations\": [              {                  \"locationType\": \"LivesIn\",                  \"latitude\": 0,                  \"longitude\": 0,                  \"country\": \"string\",                  \"state\": \"string\",                  \"county\": \"string\",                  \"city\": \"string\",                  \"zipCode\": \"string\",                  \"address\": \"string\"              }          ]      }
         * @summary Create cloud hospital admin user.
...
var CHAdminsApi = /** @class */ (function (_super) {
     ...
     * @memberof CHAdminsApi
     */
    CHAdminsApi.prototype.apiV1ChadminsGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.CHAdminsApiFp(this.configuration).apiV1ChadminsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/chadmins      {          \"firstName\": \"Cloud\",          \"lastName\": \"Hospital\",          \"photo\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"photoThumbnail\": \"https://cloudhospitalblob.blob.core.windows.net/assets/Cloud_Hospital_Logo_blue.png\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T09:09:19.082Z\",          \"locations\": [              {                  \"locationType\": \"LivesIn\",                  \"latitude\": 0,                  \"longitude\": 0,                  \"country\": \"string\",                  \"state\": \"string\",                  \"county\": \"string\",                  \"city\": \"string\",                  \"zipCode\": \"string\",                  \"address\": \"string\"              }          ]      }
     * @summary Create cloud hospital admin user.
...
exports.CHManagersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ChmanagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.CHManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ChmanagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.CHManagersApiAxiosParamCreator(configuration).apiV1ChmanagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CHManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ChmanagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.CHManagersApiFp(configuration).apiV1ChmanagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/chmanagers      {          \"userName\": \"chmanager\",          \"email\": \"chmanger@icloudhospital.com\",          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [             {             \"locationType\": \"LivesIn\",             \"latitude\": 0,             \"longitude\": 0,             \"country\": \"string\",             \"state\": \"string\",             \"county\": \"string\",             \"city\": \"string\",             \"zipCode\": \"string\",             \"address\": \"string\"             }          ]       }
         * @summary Create cloud hospital manager.
...
var CHManagersApi = /** @class */ (function (_super) {
     ...
     * @memberof CHManagersApi
     */
    CHManagersApi.prototype.apiV1ChmanagersGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.CHManagersApiFp(this.configuration).apiV1ChmanagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/chmanagers      {          \"userName\": \"chmanager\",          \"email\": \"chmanger@icloudhospital.com\",          \"firstName\": \"cloud\",          \"lastName\": \"manager\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T15:28:09.897Z\",          \"locations\": [             {             \"locationType\": \"LivesIn\",             \"latitude\": 0,             \"longitude\": 0,             \"country\": \"string\",             \"state\": \"string\",             \"county\": \"string\",             \"city\": \"string\",             \"zipCode\": \"string\",             \"address\": \"string\"             }          ]       }
     * @summary Create cloud hospital manager.
...
exports.CountriesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1CountriesGet: function (id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.CountriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1CountriesGet: function (id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.CountriesApiAxiosParamCreator(configuration).apiV1CountriesGet(id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.CountriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1CountriesGet: function (id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.CountriesApiFp(configuration).apiV1CountriesGet(id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/countries      {          \"name\": \"Korea\",          \"description\": \"Republic of Korea\",          \"medias\": [              {                  \"mediaType\": \"Photo\",                  \"url\": \"https://cloudhospitalblob.blob.core.windows.net/imagecontainer/SouthKorea.png\",                  \"thumbnailUrl\": \"https://cloudhospitalblob.blob.core.windows.net/thumbnailcontainer/SouthKorea.png\",                  \"description\": \"string\"              }          ]      }
         * @summary Create a country.
...
var CountriesApi = /** @class */ (function (_super) {
     ...
     * @memberof CountriesApi
     */
    CountriesApi.prototype.apiV1CountriesGet = function (id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.CountriesApiFp(this.configuration).apiV1CountriesGet(id, name, description, createdDate, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/countries      {          \"name\": \"Korea\",          \"description\": \"Republic of Korea\",          \"medias\": [              {                  \"mediaType\": \"Photo\",                  \"url\": \"https://cloudhospitalblob.blob.core.windows.net/imagecontainer/SouthKorea.png\",                  \"thumbnailUrl\": \"https://cloudhospitalblob.blob.core.windows.net/thumbnailcontainer/SouthKorea.png\",                  \"description\": \"string\"              }          ]      }
     * @summary Create a country.
...
exports.DealsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DealsGet: function (id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.DealsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DealsGet: function (id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DealsApiAxiosParamCreator(configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DealsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DealsGet: function (id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.DealsApiFp(configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @summary Create deal.
...
var DealsApi = /** @class */ (function (_super) {
     ...
     * @memberof DealsApi
     */
    DealsApi.prototype.apiV1DealsGet = function (id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.DealsApiFp(this.configuration).apiV1DealsGet(id, name, marketingType, countryId, hospitalId, hospitalName, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create deal.
...
exports.DepartmentApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsDepartmentsGet: function (id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.DepartmentApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsDepartmentsGet: function (id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DepartmentApiAxiosParamCreator(configuration).apiV1HospitalsDepartmentsGet(id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DepartmentApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsDepartmentsGet: function (id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.DepartmentApiFp(configuration).apiV1HospitalsDepartmentsGet(id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/departments/1
         * @summary Delete department.
...
var DepartmentApi = /** @class */ (function (_super) {
     ...
     */
    DepartmentApi.prototype.apiV1HospitalsDepartmentsGet = function (id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.DepartmentApiFp(this.configuration).apiV1HospitalsDepartmentsGet(id, hospitalId, hospitalName, name, additionalInfo, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/departments/1
     * @summary Delete department.
...
exports.DoctorCertificatesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsCertificatesGet: function (id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.DoctorCertificatesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsCertificatesGet: function (id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DoctorCertificatesApiAxiosParamCreator(configuration).apiV1DoctorsCertificatesGet(id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorCertificatesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsCertificatesGet: function (id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.DoctorCertificatesApiFp(configuration).apiV1DoctorsCertificatesGet(id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/doctors/1/certificates/1
         * @summary Delete certificate.
...
var DoctorCertificatesApi = /** @class */ (function (_super) {
     ...
     */
    DoctorCertificatesApi.prototype.apiV1DoctorsCertificatesGet = function (id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.DoctorCertificatesApiFp(this.configuration).apiV1DoctorsCertificatesGet(id, doctorId, doctorName, certificate, activeFrom, activeTo, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/doctors/1/certificates/1
     * @summary Delete certificate.
...
exports.DoctorReviewsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsReviewsGet: function (doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.DoctorReviewsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsReviewsGet: function (doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.DoctorReviewsApiAxiosParamCreator(configuration).apiV1DoctorsReviewsGet(doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorReviewsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsReviewsGet: function (doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.DoctorReviewsApiFp(configuration).apiV1DoctorsReviewsGet(doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var DoctorReviewsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorReviewsApi
     */
    DoctorReviewsApi.prototype.apiV1DoctorsReviewsGet = function (doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.DoctorReviewsApiFp(this.configuration).apiV1DoctorsReviewsGet(doctorId, doctorName, patientId, patientName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
...
exports.DoctorsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            if (options === void 0) { options = {}; }
...
exports.DoctorsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            var localVarAxiosArgs = exports.DoctorsApiAxiosParamCreator(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            return exports.DoctorsApiFp(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create hospital doctor.
...
var DoctorsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorsApi
     */
    DoctorsApi.prototype.apiV1DoctorsGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
        return exports.DoctorsApiFp(this.configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create hospital doctor.
...
exports.EquipmentsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsEquipmentsGet: function (id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.EquipmentsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsEquipmentsGet: function (id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.EquipmentsApiAxiosParamCreator(configuration).apiV1HospitalsEquipmentsGet(id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.EquipmentsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsEquipmentsGet: function (id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.EquipmentsApiFp(configuration).apiV1HospitalsEquipmentsGet(id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/equipments/1
         * @summary Delete equipment.
...
var EquipmentsApi = /** @class */ (function (_super) {
     ...
     */
    EquipmentsApi.prototype.apiV1HospitalsEquipmentsGet = function (id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.EquipmentsApiFp(this.configuration).apiV1HospitalsEquipmentsGet(id, name, description, hospitalId, hospitalName, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/equipments/1
     * @summary Delete equipment.
...
exports.HospitalReviewsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsReviewsGet: function (patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalReviewsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsReviewsGet: function (patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalReviewsApiAxiosParamCreator(configuration).apiV1HospitalsReviewsGet(patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalReviewsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsReviewsGet: function (patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.HospitalReviewsApiFp(configuration).apiV1HospitalsReviewsGet(patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var HospitalReviewsApi = /** @class */ (function (_super) {
     ...
     * @memberof HospitalReviewsApi
     */
    HospitalReviewsApi.prototype.apiV1HospitalsReviewsGet = function (patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.HospitalReviewsApiFp(this.configuration).apiV1HospitalsReviewsGet(patientId, patientName, hospitalId, hospitalName, body, recommended, reviewCategory, rate, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
...
exports.HospitalSpecialtiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalSpecialtiesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalSpecialtiesApiAxiosParamCreator(configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalSpecialtiesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsSpecialtiesGet: function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.HospitalSpecialtiesApiFp(configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var HospitalSpecialtiesApi = /** @class */ (function (_super) {
     ...
     * @memberof HospitalSpecialtiesApi
     */
    HospitalSpecialtiesApi.prototype.apiV1HospitalsSpecialtiesGet = function (hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.HospitalSpecialtiesApiFp(this.configuration).apiV1HospitalsSpecialtiesGet(hospitalId, hospitalName, specialtyId, specialtyName, specialtyTypeId, marketingType, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
...
exports.HospitalsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
         * @summary Get all hospitals.
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1
         * @summary Delete hospital.
...
var HospitalsApi = /** @class */ (function (_super) {
     ...
     */
    HospitalsApi.prototype.apiV1HospitalsCurrentGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
     * @summary Get all hospitals.
     ...
     * @memberof HospitalsApi
     */
    HospitalsApi.prototype.apiV1HospitalsGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1
     * @summary Delete hospital.
...
exports.ManagersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ManagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options) {
            if (options === void 0) { options = {}; }
...
exports.ManagersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ManagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options) {
            var localVarAxiosArgs = exports.ManagersApiAxiosParamCreator(configuration).apiV1ManagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ManagersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ManagersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options) {
            return exports.ManagersApiFp(configuration).apiV1ManagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/managers/1
         * @summary Delete hospital manager.
...
var ManagersApi = /** @class */ (function (_super) {
     ...
     */
    ManagersApi.prototype.apiV1ManagersGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options) {
        return exports.ManagersApiFp(this.configuration).apiV1ManagersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, hospitalId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/managers/1
     * @summary Delete hospital manager.
...
exports.PackagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdPackagesPackageIdDelete: function (hospitalId, packageId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsHospitalIdPackagesPackageIdGet: function (hospitalId, packageId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PackagesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdPackagesPackageIdDelete: function (hospitalId, packageId, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdPackagesPackageIdDelete(hospitalId, packageId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsHospitalIdPackagesPackageIdGet: function (hospitalId, packageId, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsHospitalIdPackagesPackageIdGet(hospitalId, packageId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PackagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsHospitalIdPackagesPackageIdDelete: function (hospitalId, packageId, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsHospitalIdPackagesPackageIdDelete(hospitalId, packageId, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/1/packages/1
         * @summary Get package.
         ...
         */
        apiV1HospitalsHospitalIdPackagesPackageIdGet: function (hospitalId, packageId, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsHospitalIdPackagesPackageIdGet(hospitalId, packageId, options)(axios, basePath);
        },
        /**
         * Sample request:        PUT /api/v1/hospitals/1/packages/1      {          \"description\": \"Upgraded medical package\"      }
         * @summary Update package.
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var PackagesApi = /** @class */ (function (_super) {
     ...
     */
    PackagesApi.prototype.apiV1HospitalsHospitalIdPackagesPackageIdDelete = function (hospitalId, packageId, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsHospitalIdPackagesPackageIdDelete(hospitalId, packageId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/1/packages/1
     * @summary Get package.
     ...
     * @memberof PackagesApi
     */
    PackagesApi.prototype.apiV1HospitalsHospitalIdPackagesPackageIdGet = function (hospitalId, packageId, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsHospitalIdPackagesPackageIdGet(hospitalId, packageId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        PUT /api/v1/hospitals/1/packages/1      {          \"description\": \"Upgraded medical package\"      }
     * @summary Update package.
     ...
     * @memberof PackagesApi
     */
    PackagesApi.prototype.apiV1HospitalsPackagesGet = function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return PackagesApi;
}(base_1.BaseAPI));
...
exports.PartnersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PartnersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PartnersApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PartnersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PartnersApiAxiosParamCreator(configuration).apiV1PartnersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PartnersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PartnersGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.PartnersApiFp(configuration).apiV1PartnersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/partners/1
         * @summary Delete patner.
...
var PartnersApi = /** @class */ (function (_super) {
     ...
     */
    PartnersApi.prototype.apiV1PartnersGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.PartnersApiFp(this.configuration).apiV1PartnersGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/partners/1
     * @summary Delete patner.
...
exports.PatientsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PatientsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PatientsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1PatientsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PatientsApiAxiosParamCreator(configuration).apiV1PatientsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PatientsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1PatientsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.PatientsApiFp(configuration).apiV1PatientsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/patients/1
         * @summary Delete patient.
...
var PatientsApi = /** @class */ (function (_super) {
     ...
     */
    PatientsApi.prototype.apiV1PatientsGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.PatientsApiFp(this.configuration).apiV1PatientsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/patients/1
     * @summary Delete patient.
...
exports.QuestionCommentsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsGet: function (questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.QuestionCommentsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsGet: function (questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsGet(questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.QuestionCommentsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsGet: function (questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsGet(questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/questions/1/questionComment      {          \"description\": \"This is a questionComment.\",          \"body\": \"questionComment body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
         * @summary Create an questionComment.
...
var QuestionCommentsApi = /** @class */ (function (_super) {
     ...
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsGet = function (questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsGet(questionId, id, userId, questionId2, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/questions/1/questionComment      {          \"description\": \"This is a questionComment.\",          \"body\": \"questionComment body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
     * @summary Create an questionComment.
...
exports.QuestionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsQuestionsGet: function (id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.QuestionsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsQuestionsGet: function (id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.QuestionsApiAxiosParamCreator(configuration).apiV1HospitalsQuestionsGet(id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.QuestionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsQuestionsGet: function (id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.QuestionsApiFp(configuration).apiV1HospitalsQuestionsGet(id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var QuestionsApi = /** @class */ (function (_super) {
     ...
     * @memberof QuestionsApi
     */
    QuestionsApi.prototype.apiV1HospitalsQuestionsGet = function (id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.QuestionsApiFp(this.configuration).apiV1HospitalsQuestionsGet(id, title, hospitalId, patientId, questionType, questionStatus, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return QuestionsApi;
}(base_1.BaseAPI));
...
exports.SearchApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SearchDealsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchDoctorsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchEquipmentsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchGetcountGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchHospitalsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SearchApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SearchDealsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchDealsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchDoctorsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchDoctorsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchEquipmentsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchEquipmentsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchGetcountGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchGetcountGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchHospitalsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchHospitalsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchSpecialtiesGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SearchApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SearchDealsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchDealsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchDoctorsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchDoctorsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchEquipmentsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchEquipmentsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchGetcountGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchGetcountGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchHospitalsGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchHospitalsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchSpecialtiesGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var SearchApi = /** @class */ (function (_super) {
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchDealsGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchDealsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchDoctorsGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchDoctorsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchEquipmentsGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchEquipmentsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchGetcountGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchGetcountGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchHospitalsGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchHospitalsGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchSpecialtiesGet = function (searchTerm, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchSpecialtiesGet(searchTerm, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return SearchApi;
}(base_1.BaseAPI));
...
exports.ServiceCategoriesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ServicecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ServiceCategoriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1ServicecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ServiceCategoriesApiAxiosParamCreator(configuration).apiV1ServicecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServiceCategoriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1ServicecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.ServiceCategoriesApiFp(configuration).apiV1ServicecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/ServiceCategories      {          \"name\": \"Adults\",          \"description\": \"There are so many “-ologists“ that they can be hard to keep straight. However, this list could be a handy reference. This is not meant to be an exhaustive and all-inclusive list of what a specialist does, but it should provide you with a basic overview.\"      }
         * @summary Create ServiceCategory.
...
var ServiceCategoriesApi = /** @class */ (function (_super) {
     ...
     */
    ServiceCategoriesApi.prototype.apiV1ServicecategoriesGet = function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.ServiceCategoriesApiFp(this.configuration).apiV1ServicecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/ServiceCategories      {          \"name\": \"Adults\",          \"description\": \"There are so many “-ologists“ that they can be hard to keep straight. However, this list could be a handy reference. This is not meant to be an exhaustive and all-inclusive list of what a specialist does, but it should provide you with a basic overview.\"      }
     * @summary Create ServiceCategory.
...
exports.ServicesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.ServicesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.ServicesApiAxiosParamCreator(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.ServicesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsServicesGet: function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.ServicesApiFp(configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var ServicesApi = /** @class */ (function (_super) {
     ...
     * @memberof ServicesApi
     */
    ServicesApi.prototype.apiV1HospitalsServicesGet = function (id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.ServicesApiFp(this.configuration).apiV1HospitalsServicesGet(id, name, description, hospitalId, hospitalName, specialtyId, specialtyTypeId, specialtyTypeName, marketingType, procedure, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return ServicesApi;
}(base_1.BaseAPI));
...
exports.SpecialtiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtiesGet: function (id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SpecialtiesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtiesGet: function (id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SpecialtiesApiAxiosParamCreator(configuration).apiV1SpecialtiesGet(id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtiesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtiesGet: function (id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SpecialtiesApiFp(configuration).apiV1SpecialtiesGet(id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/specialties      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyType\": \"Cardiology\"      }
         * @summary Create specialty.
...
var SpecialtiesApi = /** @class */ (function (_super) {
     ...
     */
    SpecialtiesApi.prototype.apiV1SpecialtiesGet = function (id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SpecialtiesApiFp(this.configuration).apiV1SpecialtiesGet(id, name, description, specialtyTypeId, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/specialties      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyType\": \"Cardiology\"      }
     * @summary Create specialty.
...
exports.SpecialtyTypeCategoriesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SpecialtyTypeCategoriesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtytypecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SpecialtyTypeCategoriesApiAxiosParamCreator(configuration).apiV1SpecialtytypecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtyTypeCategoriesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtytypecategoriesGet: function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SpecialtyTypeCategoriesApiFp(configuration).apiV1SpecialtytypecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/SpecialtyTypeCategories      {          \"name\": \"Adults\",          \"description\": \"There are so many “-ologists“ that they can be hard to keep straight. However, this list could be a handy reference. This is not meant to be an exhaustive and all-inclusive list of what a specialist does, but it should provide you with a basic overview.\"      }
         * @summary Create specialtyTypeCategory.
...
var SpecialtyTypeCategoriesApi = /** @class */ (function (_super) {
     ...
     */
    SpecialtyTypeCategoriesApi.prototype.apiV1SpecialtytypecategoriesGet = function (id, name, description, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SpecialtyTypeCategoriesApiFp(this.configuration).apiV1SpecialtytypecategoriesGet(id, name, description, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/SpecialtyTypeCategories      {          \"name\": \"Adults\",          \"description\": \"There are so many “-ologists“ that they can be hard to keep straight. However, this list could be a handy reference. This is not meant to be an exhaustive and all-inclusive list of what a specialist does, but it should provide you with a basic overview.\"      }
     * @summary Create specialtyTypeCategory.
...
exports.SpecialtyTypesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SpecialtyTypesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SpecialtyTypesApiAxiosParamCreator(configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SpecialtyTypesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SpecialtytypesGet: function (id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.SpecialtyTypesApiFp(configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/SpecialtyTypes      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyTypeType\": \"Cardiology\"      }
         * @summary Create specialtyType.
...
var SpecialtyTypesApi = /** @class */ (function (_super) {
     ...
     */
    SpecialtyTypesApi.prototype.apiV1SpecialtytypesGet = function (id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.SpecialtyTypesApiFp(this.configuration).apiV1SpecialtytypesGet(id, name, description, marketingType, created, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/SpecialtyTypes      {          \"name\": \"Coronary artery disease\",          \"description\": \"Coronary artery disease\",          \"specialtyTypeType\": \"Cardiology\"      }
     * @summary Create specialtyType.
...
exports.YoutubesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1YoutubesGet: function (id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.YoutubesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1YoutubesGet: function (id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.YoutubesApiAxiosParamCreator(configuration).apiV1YoutubesGet(id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.YoutubesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1YoutubesGet: function (id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options) {
            return exports.YoutubesApiFp(configuration).apiV1YoutubesGet(id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/youtubes      {          \"title\": \"Samsung Hospital Youtube\",          \"description\": \"This is an youtube.\",          \"body\": \"youtube body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"tags\": [            {              \"value\": \"string\",              \"order\": 0              }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
         * @summary Create an youtube.
...
var YoutubesApi = /** @class */ (function (_super) {
     ...
     */
    YoutubesApi.prototype.apiV1YoutubesGet = function (id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options) {
        return exports.YoutubesApiFp(this.configuration).apiV1YoutubesGet(id, title, normalizedTitle, description, marketingType, tag, page, limit, countOnly, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/youtubes      {          \"title\": \"Samsung Hospital Youtube\",          \"description\": \"This is an youtube.\",          \"body\": \"youtube body here\",          \"status\": \"Draft\",          \"hospitalId\": 1,          \"tags\": [            {              \"value\": \"string\",              \"order\": 0              }          ],          \"medias\": [            {              \"mediaType\": \"Photo\",              \"url\": \"string\",              \"thumbnailUrl\": \"string\",              \"description\": \"string\",              \"order\": 0            }          ]      }
     * @summary Create an youtube.
