...
exports.PackagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsPackagesGet: function (id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PackagesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsPackagesGet(id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PackagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsPackagesGet(id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var PackagesApi = /** @class */ (function (_super) {
     ...
     * @memberof PackagesApi
     */
    PackagesApi.prototype.apiV1HospitalsPackagesGet = function (id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsPackagesGet(id, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return PackagesApi;
}(base_1.BaseAPI));
...
exports.QuestionCommentsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (hospitalId, questionId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
                throw new base_1.RequiredError('hospitalId', 'Required parameter hospitalId was null or undefined when calling apiV1QuestionsQuestionIdQuestioncommentsPost.');
            }
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete: function (hospitalId, questionId, questionCommentId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
                throw new base_1.RequiredError('hospitalId', 'Required parameter hospitalId was null or undefined when calling apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete.');
            }
            // verify required parameter 'questionId' is not null or undefined
            if (questionId === null || questionId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet: function (hospitalId, questionId, questionCommentId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
                throw new base_1.RequiredError('hospitalId', 'Required parameter hospitalId was null or undefined when calling apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet.');
            }
            // verify required parameter 'questionId' is not null or undefined
            if (questionId === null || questionId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (hospitalId, questionId, questionCommentId, body, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'hospitalId' is not null or undefined
            if (hospitalId === null || hospitalId === undefined) {
                throw new base_1.RequiredError('hospitalId', 'Required parameter hospitalId was null or undefined when calling apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut.');
            }
            // verify required parameter 'questionId' is not null or undefined
            if (questionId === null || questionId === undefined) {
         ...
         * @throws {RequiredError}
         */
        apiV1QuestionsQuestioncommentsGet: function (id, userId, questionId, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/api/v1/questions/questioncomments";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
exports.QuestionCommentsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (hospitalId, questionId, body, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(hospitalId, questionId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete: function (hospitalId, questionId, questionCommentId, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete(hospitalId, questionId, questionCommentId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet: function (hospitalId, questionId, questionCommentId, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet(hospitalId, questionId, questionCommentId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (hospitalId, questionId, questionCommentId, body, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(hospitalId, questionId, questionCommentId, body, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1QuestionsQuestioncommentsGet: function (id, userId, questionId, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.QuestionCommentsApiAxiosParamCreator(configuration).apiV1QuestionsQuestioncommentsGet(id, userId, questionId, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.QuestionCommentsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsPost: function (hospitalId, questionId, body, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(hospitalId, questionId, body, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1/questions/1/questionComments/1
         * @summary Delete questionComment.
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete: function (hospitalId, questionId, questionCommentId, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete(hospitalId, questionId, questionCommentId, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/1/questionComment/1
         * @summary Get questionComment.
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet: function (hospitalId, questionId, questionCommentId, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet(hospitalId, questionId, questionCommentId, options)(axios, basePath);
        },
        /**
         * Sample request:        PUT /api/v1/hospitals/1/questions/1/questionComments/1      {          \"QuestionTitle\": \"Question title\",          \"body\": \"updated questionComment body here\"      }
         * @summary Update questionComment.
         ...
         */
        apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut: function (hospitalId, questionId, questionCommentId, body, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(hospitalId, questionId, questionCommentId, body, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals/1/questionComment
         * @summary Get all questionComment.
         ...
         */
        apiV1QuestionsQuestioncommentsGet: function (id, userId, questionId, page, limit, lastRetrieved, current, options) {
            return exports.QuestionCommentsApiFp(configuration).apiV1QuestionsQuestioncommentsGet(id, userId, questionId, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var QuestionCommentsApi = /** @class */ (function (_super) {
     ...
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsPost = function (hospitalId, questionId, body, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsPost(hospitalId, questionId, body, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1/questions/1/questionComments/1
     * @summary Delete questionComment.
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete = function (hospitalId, questionId, questionCommentId, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdDelete(hospitalId, questionId, questionCommentId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/1/questionComment/1
     * @summary Get questionComment.
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet = function (hospitalId, questionId, questionCommentId, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdGet(hospitalId, questionId, questionCommentId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        PUT /api/v1/hospitals/1/questions/1/questionComments/1      {          \"QuestionTitle\": \"Question title\",          \"body\": \"updated questionComment body here\"      }
     * @summary Update questionComment.
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut = function (hospitalId, questionId, questionCommentId, body, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestionIdQuestioncommentsQuestionCommentIdPut(hospitalId, questionId, questionCommentId, body, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals/1/questionComment
     * @summary Get all questionComment.
     ...
     * @memberof QuestionCommentsApi
     */
    QuestionCommentsApi.prototype.apiV1QuestionsQuestioncommentsGet = function (id, userId, questionId, page, limit, lastRetrieved, current, options) {
        return exports.QuestionCommentsApiFp(this.configuration).apiV1QuestionsQuestioncommentsGet(id, userId, questionId, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
