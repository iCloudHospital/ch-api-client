...
exports.DoctorsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            if (options === void 0) { options = {}; }
...
exports.DoctorsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            var localVarAxiosArgs = exports.DoctorsApiAxiosParamCreator(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.DoctorsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1DoctorsGet: function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
            return exports.DoctorsApiFp(configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options)(axios, basePath);
        },
        /**
         * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
         * @summary Create hospital doctor.
...
var DoctorsApi = /** @class */ (function (_super) {
     ...
     * @memberof DoctorsApi
     */
    DoctorsApi.prototype.apiV1DoctorsGet = function (id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options) {
        return exports.DoctorsApiFp(this.configuration).apiV1DoctorsGet(id, fullname, email, gender, dateOfBirth, created, page, limit, lastRetrieved, current, countryId, hospitalId, marketingType, specialtyTypeId, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        POST /api/v1/doctors      {          \"userName\": \"cloudDoctor\",          \"email\": \"doctor@icloudhospital.com\",          \"hospitalId\": 1,          \"firstName\": \"cloud\",          \"lastName\": \"doctor\",          \"photo\": \"string\",          \"photoThumbnail\": \"string\",          \"gender\": \"NotSpecified\",          \"dateOfBirth\": \"2020-02-22T17:57:32.048Z\",          \"locations\": [            {              \"locationType\": \"LivesIn\",              \"latitude\": 0,              \"longitude\": 0,              \"country\": \"string\",              \"state\": \"string\",              \"county\": \"string\",              \"city\": \"string\",              \"zipCode\": \"string\",              \"address\": \"string\"            }          ]      }
     * @summary Create hospital doctor.
...
exports.HospitalsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.HospitalsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.HospitalsApiAxiosParamCreator(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.HospitalsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsCurrentGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
         * @summary Get all hospitals.
         ...
         */
        apiV1HospitalsGet: function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
            return exports.HospitalsApiFp(configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         * Sample request:        DELETE /api/v1/hospitals/1
         * @summary Delete hospital.
...
var HospitalsApi = /** @class */ (function (_super) {
     ...
     */
    HospitalsApi.prototype.apiV1HospitalsCurrentGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsCurrentGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        GET /api/v1/hospitals      {          \"pageQueryFilter\": {              \"page\": 1,              \"limit\": 20,              \"lastRetrived\": \"2020-02-05T08:40\"          },          \"searchString\": \"Samsung\"      }
     * @summary Get all hospitals.
     ...
     * @memberof HospitalsApi
     */
    HospitalsApi.prototype.apiV1HospitalsGet = function (id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options) {
        return exports.HospitalsApiFp(this.configuration).apiV1HospitalsGet(id, name, description, countryId, created, marketingType, specialtyTypeId, specialtyId, serviceId, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     * Sample request:        DELETE /api/v1/hospitals/1
     * @summary Delete hospital.
...
exports.PackagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.PackagesApiFp = function (configuration) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.PackagesApiAxiosParamCreator(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.PackagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1HospitalsPackagesGet: function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options) {
            return exports.PackagesApiFp(configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var PackagesApi = /** @class */ (function (_super) {
     ...
     * @memberof PackagesApi
     */
    PackagesApi.prototype.apiV1HospitalsPackagesGet = function (relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options) {
        return exports.PackagesApiFp(this.configuration).apiV1HospitalsPackagesGet(relatedPackageId, name, countryId, hospitalId, hospitalName, marketingType, packageStatus, specialtyTypeId, serviceId, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return PackagesApi;
}(base_1.BaseAPI));
...
exports.SearchApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1SearchDealsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchDoctorsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchEquipmentsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchGetcountGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchHospitalsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.SearchApiFp = function (configuration) {
    return {
         ...
         */
        apiV1SearchDealsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchDealsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchDoctorsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchDoctorsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchEquipmentsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchEquipmentsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchGetcountGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchGetcountGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchHospitalsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchHospitalsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.SearchApiAxiosParamCreator(configuration).apiV1SearchSpecialtiesGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.SearchApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1SearchDealsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchDealsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchDoctorsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchDoctorsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchEquipmentsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchEquipmentsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchGetcountGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchGetcountGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchHospitalsGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchHospitalsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @param {string} [searchTerm]
         ...
         */
        apiV1SearchSpecialtiesGet: function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
            return exports.SearchApiFp(configuration).apiV1SearchSpecialtiesGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
    };
};
/**
...
var SearchApi = /** @class */ (function (_super) {
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchDealsGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchDealsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchDoctorsGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchDoctorsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchEquipmentsGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchEquipmentsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchGetcountGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchGetcountGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchHospitalsGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchHospitalsGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @param {string} [searchTerm]
     ...
     * @memberof SearchApi
     */
    SearchApi.prototype.apiV1SearchSpecialtiesGet = function (searchTerm, countOnly, page, limit, lastRetrieved, current, options) {
        return exports.SearchApiFp(this.configuration).apiV1SearchSpecialtiesGet(searchTerm, countOnly, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    return SearchApi;
}(base_1.BaseAPI));
