...
exports.BookingsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1BookingsGet: function (searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options) {
            if (options === void 0) { options = {}; }
...
exports.BookingsApiFp = function (configuration) {
    return {
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options) {
            var localVarAxiosArgs = exports.BookingsApiAxiosParamCreator(configuration).apiV1BookingsGet(searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = axios_1.default; }
                if (basePath === void 0) { basePath = base_1.BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
exports.BookingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        apiV1BookingsGet: function (searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options) {
            return exports.BookingsApiFp(configuration).apiV1BookingsGet(searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options)(axios, basePath);
        },
        /**
         *
         * @summary Create a booking.
...
var BookingsApi = /** @class */ (function (_super) {
     ...
     * @memberof BookingsApi
     */
    BookingsApi.prototype.apiV1BookingsGet = function (searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options) {
        return exports.BookingsApiFp(this.configuration).apiV1BookingsGet(searchString, isOpen, bookingStatus, page, limit, lastRetrieved, current, options)(this.axios, this.basePath);
    };
    /**
     *
     * @summary Create a booking.
